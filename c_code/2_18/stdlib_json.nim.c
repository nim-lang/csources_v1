...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q*, parseFile__Q9bbQtVlwjGc4S8fnWe9b3YA)(NimStringDesc* filename) {	tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q* result;
	...
	{
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym464002_;
		NimStringDesc* T5_;
		if (!(stream == NIM_NIL)) goto LA3_;
		eX60gensym464002_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym464002_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym464002_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym464002_).Sup.Sup.name = "IOError";
		T5_ = (NimStringDesc*)0;
...
appendString(T5_, filename);
		asgnRef((void**) (&(*eX60gensym464002_).Sup.Sup.message), T5_);
		asgnRef((void**) (&(*eX60gensym464002_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym464002_, "IOError", "parseFile", "json.nim", 877);
	}
	LA3_: ;
