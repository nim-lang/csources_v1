...
TNimType NTI__cC4ce9cdvDKtIpar5g9cDejA_;
...
static N_INLINE(void, bitincl__E9cDk0lZrpCTkoPoFYHbLEAintsets)(tyObject_IntSet__PQrmFm4BXFkFSVOUl1ojSg* s, NI key) {	tyObject_Trunk__ul49aWfv9aes8cutmeltT3gQ* t;
	NI u;
	t = intSetPut__JuDvqAxqqazeTie5vkhxBA(s, (NI)((NI32)(key) >> (NU32)(((NI) 9))));
	u = (NI)(key & ((NI) 511));
...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		...
		t = intSetGet__sgEEbaJIQsQO4zFm2Zy3yQ((&(*s)), (NI)((NI32)(key) >> (NU32)(((NI) 9))));
		{
			NI u;
...
NTI__cC4ce9cdvDKtIpar5g9cDejA_.size = sizeof(tyArray__cC4ce9cdvDKtIpar5g9cDejA);
NTI__cC4ce9cdvDKtIpar5g9cDejA_.kind = 16;
NTI__cC4ce9cdvDKtIpar5g9cDejA_.base = (&NTI__hMQEc0FMry7Up7EoPki79aA_);
NTI__cC4ce9cdvDKtIpar5g9cDejA_.flags = 3;
...
TM__ulJ2WYumkJwZ9b5Ewe7sCpg_0[8].typ = (&NTI__cC4ce9cdvDKtIpar5g9cDejA_);
