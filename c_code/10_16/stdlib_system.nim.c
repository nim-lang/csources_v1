...
N_LIB_PRIVATE N_NIMCALL(void, delete__FxJSSlM1HtYUBJdvsqL6Sg)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ** x, NI i) {	NI xlX60gensym331201_;
	NI T1_;
	T1_ = ((*x) ? (*x)->Sup.len : 0);
	xlX60gensym331201_ = T1_;
	{
		NI jX60gensym331202_;
		NI colontmp_;
		NI colontmp__2;
		NI res;
		jX60gensym331202_ = (NI)0;
		colontmp_ = (NI)0;
		colontmp__2 = (NI)0;
		colontmp_ = ((NI) (i));
		colontmp__2 = (NI)(xlX60gensym331201_ - ((NI) 2));
		res = colontmp_;
		{
			while (1) {
				if (!(res <= colontmp__2)) goto LA4;
				jX60gensym331202_ = res;
				asgnRef((void**) (&(*x)->data[jX60gensym331202_]), (*x)->data[(NI)(jX60gensym331202_ + ((NI) 1))]);
				res += ((NI) 1);
			} LA4: ;
		}
	}
	unsureAsgnRef((void**) (&(*x)), (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) setLengthSeqV2(&((*x))->Sup, (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_), ((NI) ((NI)(xlX60gensym331201_ - ((NI) 1))))));
}
