...
TNimType NTI__KWIQnzXEOUqdWsnCUL9atyQ_;
extern TNimType NTI__77mFvmsOLKik79ci2hXkHEg_;
TNimType NTI__Q9c4KaNqJU4PbXaGht0C7iw_;
TNimType NTI__0zjE9c54eTrq224F5wMcaFA_;
TNimType NTI__G9cw5MrJXJrcpID5JXaplew_;
TNimType NTI__Na0rM2Zdr3RpxeNeXbvLrQ_;
TNimType NTI__Ih0V9cYug0VPJyBBGvgEH7Q_;
extern TNimType NTI__VaVACK0bpYmqIQ0mKcHfQQ_;
extern TNimType NTI__yoNlBGx0D2tRizIdhQuENw_;
TNimType NTI__XTejXaID1NT7KS9byQm3Jxg_;
TNimType NTI__PyuSdojUZWOAnzN7dInq1Q_;
...
NIM_CONST tySequence__Ih0V9cYug0VPJyBBGvgEH7Q* TM__nIinruGrC8EPIfjL3PuTvA_16 = ((tySequence__Ih0V9cYug0VPJyBBGvgEH7Q*)&TM__nIinruGrC8EPIfjL3PuTvA_17);
...
NIM_CONST tyArray__FkG8aLMyiZfDjueUwWl3WA tokToStr__JGKyaHusNBrTLCQ7XiBnyw = {((NimStringDesc*) &TM__nIinruGrC8EPIfjL3PuTvA_25),
...
N_LIB_PRIVATE N_NIMCALL(void, open__caSf5pJv2JnMMpxc9bAhdpA)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my, tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* input, NimStringDesc* filename, NIM_BOOL rawStringLiterals) {	tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* T1_;
...
N_LIB_PRIVATE N_NIMCALL(void, skip__FPdQ9beZqb3bJ7eVHJww6Qg_2)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	NI pos;
	pos = (*my).Sup.bufpos;
	{
		while (1) {
...
N_LIB_PRIVATE N_NIMCALL(void, parseNumber__FPdQ9beZqb3bJ7eVHJww6Qg_3)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	NI pos;
	pos = (*my).Sup.bufpos;
	{
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, handleHexChar__Avai9b5a9bb83l1HPqx75AfA)(NIM_CHAR c, NI* x) {	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = NIM_TRUE;
	switch (((NU8)(c))) {
	case 48 ... 57:
...
N_LIB_PRIVATE N_NIMCALL(NI, parseEscapedUTF16__MMwgsOXZK0fQw6h7UQcVsQ)(NCSTRING buf, NI* pos) {	NI result;
{	result = (NI)0;
	result = ((NI) 0);
	{
		NI _;
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw, parseString__9cGllg9a4hN9cmfjsUw6zu39bQ_2)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw result;
	NI pos;
...
N_LIB_PRIVATE N_NIMCALL(void, parseName__FPdQ9beZqb3bJ7eVHJww6Qg_4)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	NI pos;
	pos = (*my).Sup.bufpos;
	{
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw, getTok__9cGllg9a4hN9cmfjsUw6zu39bQ)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw result;
	result = (tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw)0;
...
static N_INLINE(tyEnum_ParserState__Na0rM2Zdr3RpxeNeXbvLrQ, pop__wGIX8i2tVhp4gFSPlGuf2gsystem)(tySequence__Ih0V9cYug0VPJyBBGvgEH7Q** s) {	tyEnum_ParserState__Na0rM2Zdr3RpxeNeXbvLrQ result;
	NI L;
	NI T1_;
	...
	L = (NI)(T1_ - ((NI) 1));
	result = (*s)->data[L];
	unsureAsgnRef((void**) (&(*s)), (tySequence__Ih0V9cYug0VPJyBBGvgEH7Q*) setLengthSeqV2(&((*s))->Sup, (&NTI__Ih0V9cYug0VPJyBBGvgEH7Q_), ((NI) (L))));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, next__FPdQ9beZqb3bJ7eVHJww6Qg)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	tyEnum_TokKind__Q9c4KaNqJU4PbXaGht0C7iw tk;
	NI i;
	NI T1_;
	...
	case ((tyEnum_ParserState__Na0rM2Zdr3RpxeNeXbvLrQ) 1):
	{
		...
		{
			NI T11_;
			unsureAsgnRef((void**) (&(*my).state), (tySequence__Ih0V9cYug0VPJyBBGvgEH7Q*) incrSeqV3((TGenericSeq*)((*my).state), (&NTI__Ih0V9cYug0VPJyBBGvgEH7Q_)));
...
static N_INLINE(NI, getLine__cAlRX82MU9aihWfxn79b1A6wparsejson)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	NI result;
	result = (NI)0;
	result = (*my).Sup.lineNumber;
	return result;
}
static N_INLINE(NI, getColumn__cAlRX82MU9aihWfxn79b1A6w_2parsejson)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my) {	NI result;
	result = (NI)0;
	result = getColNumber__KUMaHICF9bUPO7tt6hrBs3g((&(*my).Sup), (*my).Sup.bufpos);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, errorMsgExpected__wyJNOK33UcOVCdJ9aSuAbOw)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* my, NimStringDesc* e) {	NimStringDesc* result;
...
N_LIB_PRIVATE N_NOINLINE(void, raiseParseErr__VeBRAkMdST9cPQW1Rqk8vwA)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* p, NimStringDesc* msg) {	tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg* eX60gensym442962_;
	eX60gensym442962_ = (tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg*)0;
	eX60gensym442962_ = (tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg*) newObj((&NTI__PyuSdojUZWOAnzN7dInq1Q_), sizeof(tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg));
	(*eX60gensym442962_).Sup.Sup.Sup.Sup.m_type = (&NTI__XTejXaID1NT7KS9byQm3Jxg_);
	(*eX60gensym442962_).Sup.Sup.Sup.name = "JsonParsingError";
	asgnRef((void**) (&(*eX60gensym442962_).Sup.Sup.Sup.message), errorMsgExpected__wyJNOK33UcOVCdJ9aSuAbOw(p, msg));
	asgnRef((void**) (&(*eX60gensym442962_).Sup.Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym442962_, "JsonParsingError", "raiseParseErr", "parsejson.nim", 522);
}
