...
N_LIB_PRIVATE N_NIMCALL(void, newLine__Seop6SJMf7a68kj2jl0nsQ_2)(tyObject_TTmplParser__hVXV9cC75rOvsaODz9bp1zeg* p) {	NimStringDesc* T1_;
	...
	LA4_: ;
	{
		...
		T10_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) 2));
...
break;
		...
		LA28_: ;
		{
			...
			T40_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((*p).indent)));
		...
		LA29_: ;
		{
			...
			T42_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((*p).indent)));
		...
		LA30_: ;
		{
			...
			T45_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((NI)((*p).indent - ((NI) 2)))));
		...
		LA31_: ;
		{
			...
			T48_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((*p).indent)));
		...
		LA32_: ;
		{
			...
			T56_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((*p).indent)));
	...
	LA16_: ;
	{
		...
		case ((tyEnum_TParseState__TMyoReN7VAtsUpVF9bL9cXRQ) 1):
		{
			...
			T60_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((NI)((*p).indent + ((NI) 2)))));
		...
		case ((tyEnum_TParseState__TMyoReN7VAtsUpVF9bL9cXRQ) 0):
		{
			...
			T62_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) ((*p).indent)));
