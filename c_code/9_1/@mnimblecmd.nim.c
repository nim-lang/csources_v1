			...
			if (TM__asNQM9aynXXg9ccUABbReyew_2.status == 0) {
				{
					while (1) {
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T19_ = (NIM_BOOL)0;
							T19_ = !(eqStrings(y, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_3)));
							if (!(T19_)) goto LA20_;
							T19_ = !(eqStrings(y, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_4)));
							LA20_: ;
							if (!T19_) goto LA21_;
							...
							p = y;
							{
								NIM_BOOL T43_;
								T43_ = (NIM_BOOL)0;
								T43_ = (k == ((tyEnum_PathComponent__9c1SIU9cO1wHcl09b703A9cDrg) 2));
								if (!(T43_)) goto LA44_;
