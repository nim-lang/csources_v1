...
N_LIB_PRIVATE N_NIMCALL(void, evalTemplateAux__AHGrgjfRCGeqRF8aKpZ9apw)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* templ, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* actual, tyObject_TemplCtx__og0XwfDLUlsX2HzoVx0s3Q* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result) {	switch ((*templ).kind) {
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		...
		s = (*templ).sym;
		{
			...
			{
				NIM_BOOL T12_;
				tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* xX60gensym859146_;
				T12_ = (NIM_BOOL)0;
				...
				LA13_: ;
				if (!T12_) goto LA14_;
				xX60gensym859146_ = (*actual).sons->data[(*s).position];
				{
					if (!((*xX60gensym859146_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA18_;
					{
						tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* yX60gensym859147_;
						yX60gensym859147_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
						{
							NI i;
							NI colontmp_;
							NI i_2;
							i = (NI)0;
							colontmp_ = (NI)0;
							colontmp_ = safeLen__P89cqdlERShb9alU3iC0yj8w_2ast(xX60gensym859146_);
							i_2 = ((NI) 0);
							{
								while (1) {
									if (!(i_2 < colontmp_)) goto LA23;
									i = i_2;
									yX60gensym859147_ = (*xX60gensym859146_).sons->data[i];
									add__P8dDSotTW25BkfbyspojGg(result, yX60gensym859147_);
									i_2 += ((NI) 1);
								} LA23: ;
							}
						}
				...
				LA18_: ;
				{
					...
					T25_ = copyTree__Dsjo9bte8vGxzhtcSrsTyiQ_2(xX60gensym859146_);
			...
			LA14_: ;
			{
				...
				NIM_BOOL T31_;
				NIM_BOOL T32_;
				tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* xX60gensym859193_;
				NI T37_;
				T27_ = (NIM_BOOL)0;
				...
				xX60gensym859193_ = (*actual).sons->data[(NI)((NI)(T37_ + (*s).position) - ((NI) 1))];
				{
					if (!((*xX60gensym859193_).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152))) goto LA40_;
					{
						tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* yX60gensym859194_;
						yX60gensym859194_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
						{
							NI i_3;
							NI colontmp__2;
							NI i_4;
							i_3 = (NI)0;
							colontmp__2 = (NI)0;
							colontmp__2 = safeLen__P89cqdlERShb9alU3iC0yj8w_2ast(xX60gensym859193_);
							i_4 = ((NI) 0);
							{
								while (1) {
									if (!(i_4 < colontmp__2)) goto LA45;
									i_3 = i_4;
									yX60gensym859194_ = (*xX60gensym859193_).sons->data[i_3];
									add__P8dDSotTW25BkfbyspojGg(result, yX60gensym859194_);
									i_4 += ((NI) 1);
								} LA45: ;
							}
						}
				...
				LA40_: ;
				{
					...
					T47_ = copyTree__Dsjo9bte8vGxzhtcSrsTyiQ_2(xX60gensym859193_);
