...
TNimType NTI__3cfjXoK9cq3IucSxmZjilvQ_;
extern TNimType NTI__a8lycfSA25OQltN3OMeBsA_;
TNimType NTI__k2ywiSfZIGb5TslFNwYcuQ_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, verboseOpen__sGmRIy9cHg17AV3Qi5TDHlQ)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* s) {	tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* result;
	...
	T1_ = (tyObject_VerboseRefcolonObjectType___3cfjXoK9cq3IucSxmZjilvQ*) newObj((&NTI__k2ywiSfZIGb5TslFNwYcuQ_), sizeof(tyObject_VerboseRefcolonObjectType___3cfjXoK9cq3IucSxmZjilvQ));
	(*T1_).Sup.Sup.m_type = (&NTI__3cfjXoK9cq3IucSxmZjilvQ_);
	asgnRef((void**) (&(*T1_).config), (*graph).config);
	result = &T1_->Sup;
	rawMessage__h30HgTFwbGq0PsyHmRqZ8g((*graph).config, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 52), (*(*s).name).s);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, verboseProcess__LKmuPCJqFCiS9axSu9axOmdw)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* context, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	...
	v = ((tyObject_VerboseRefcolonObjectType___3cfjXoK9cq3IucSxmZjilvQ*) (context));
	{
		...
		(*(*v).config).notes |= ((NU64)1)<<(((((tyEnum_TMsgKind__aF3wrShfYWgzGfsrtvM3hQ) 52)- 11)) & 63);
		T5_ = (NimStringDesc*)0;
		T5_ = nimIntToStr(gFrontEndId__gyRrMPnY7JyC6tAu9bCfGng);
		message__mMj7lrOf3zBP9bl69amiKu5g((*v).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 52), T5_);
	}
	LA3_: ;
	return result;
}
...
NTI__3cfjXoK9cq3IucSxmZjilvQ_.size = sizeof(tyObject_VerboseRefcolonObjectType___3cfjXoK9cq3IucSxmZjilvQ);
NTI__3cfjXoK9cq3IucSxmZjilvQ_.kind = 17;
NTI__3cfjXoK9cq3IucSxmZjilvQ_.base = (&NTI__Hb6rFM0ecvtlLf2kv9aU75w_);
...
TM__WN2DmcgfohRZOHm9avzMtLw_0[0].typ = (&NTI__a8lycfSA25OQltN3OMeBsA_);
TM__WN2DmcgfohRZOHm9avzMtLw_0[0].name = "config";
NTI__3cfjXoK9cq3IucSxmZjilvQ_.node = &TM__WN2DmcgfohRZOHm9avzMtLw_0[0];
NTI__k2ywiSfZIGb5TslFNwYcuQ_.size = sizeof(tyObject_VerboseRefcolonObjectType___3cfjXoK9cq3IucSxmZjilvQ*);
NTI__k2ywiSfZIGb5TslFNwYcuQ_.kind = 22;
NTI__k2ywiSfZIGb5TslFNwYcuQ_.base = (&NTI__3cfjXoK9cq3IucSxmZjilvQ_);
NTI__k2ywiSfZIGb5TslFNwYcuQ_.marker = Marker_tyRef__k2ywiSfZIGb5TslFNwYcuQ;
}
