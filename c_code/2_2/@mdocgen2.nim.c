...
tyObject_TDocumentor__aItnR9bvqDIftcasLwUztVQ* doc;
...
N_LIB_PRIVATE N_NIMCALL(void, writeOutputJson__7W8HhP9cLoIdLMqjvSJvHmg_2)(tyObject_TDocumentor__aItnR9bvqDIftcasLwUztVQ* d, NIM_BOOL useWarning);
...
TNimType NTI__QzRwKNjgUGyiY7E27E59ayg_;
extern TNimType NTI__ZoZ1pRtzmEiOBBpTrqMZHA_;
extern TNimType NTI__K9bspPztfoWajecnwjyHuYQ_;
extern TNimType NTI__a8lycfSA25OQltN3OMeBsA_;
TNimType NTI__IvUIgn2r9aXG5PmmODg7iBg_;
...
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
STRING_LITERAL(TM__87tQLGE73DKq5cz9cph1IqQ_3, "json", 4);
STRING_LITERAL(TM__87tQLGE73DKq5cz9cph1IqQ_5, "html", 4);
static N_NIMCALL(void, Marker_tyRef__IvUIgn2r9aXG5PmmODg7iBg)(void* p, NI op) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpenJson__XkBOXGkEnDAtwimfvAgjZQ)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* module) {	tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* result;
	...
	g = (tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*) newObj((&NTI__IvUIgn2r9aXG5PmmODg7iBg_), sizeof(tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg));
	(*g).Sup.Sup.m_type = (&NTI__QzRwKNjgUGyiY7E27E59ayg_);
	asgnRef((void**) (&(*g).module), module);
	asgnRef((void**) (&(*g).config), (*graph).config);
	T1_ = (NimStringDesc*)0;
	T1_ = toFullPath__VW1RaR1l9c9bPnJxr1KuvIrg((*graph).config, ((NI32) ((*module).position)));
	d = newDocumentor__4NQNwjts5pclqjg2wHmDug(T1_, (*graph).cache, (*graph).config, ((NimStringDesc*) &TM__87tQLGE73DKq5cz9cph1IqQ_3), module);
	(*d).Sup.hasToc = NIM_TRUE;
	asgnRef((void**) (&(*g).doc), d);
	result = &g->Sup;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processNodeJson__89cQsBb9a40vsSUZ26PjkTPQ)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg* g;
	...
	g = ((tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*) (c));
	{
		...
		if (!(T5_)) goto LA6_;
		T5_ = (((*(*(*g).doc).conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 33))&63U)))!=0);
		LA6_: ;
		T4_ = T5_;
		if (T4_) goto LA7_;
		T4_ = (((*(*g).module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 13))&63U)))!=0);
		LA7_: ;
		T3_ = T4_;
		if (T3_) goto LA8_;
		...
		LA8_: ;
		if (!T3_) goto LA9_;
		generateJson__aCcnJCcOFu8Y1ZdiDOUa6Q((*g).doc, n, NIM_FALSE);
	}
	LA9_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, closeJson__GrB9cG0YoTacDwWggL1RK7g)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	...
	useWarning = !((((*(*g).module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 13))&63U)))!=0));
	{
		NIM_BOOL T3_;
		NIM_BOOL T4_;
		NIM_BOOL T5_;
		...
		LA8_: ;
		if (!T3_) goto LA9_;
		writeOutputJson__7W8HhP9cLoIdLMqjvSJvHmg_2((*g).doc, useWarning);
		...
		if (TM__87tQLGE73DKq5cz9cph1IqQ_4.status == 0) {
			generateIndex__6UjzL2rSgVAuceHWxn9c01Q_2((*g).doc);
			popSafePoint();
		}
		else {
			popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpen__XkBOXGkEnDAtwimfvAgjZQ_2)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* module) {	tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* result;
	tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg* g;
	tyObject_TDocumentor__aItnR9bvqDIftcasLwUztVQ* d;
	NimStringDesc* T1_;
	result = (tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*)0;
	...
	T1_ = (NimStringDesc*)0;
	T1_ = toFullPath__VW1RaR1l9c9bPnJxr1KuvIrg((*graph).config, ((NI32) ((*module).position)));
	d = newDocumentor__4NQNwjts5pclqjg2wHmDug(T1_, (*graph).cache, (*graph).config, ((NimStringDesc*) &TM__87tQLGE73DKq5cz9cph1IqQ_5), module);
	(*d).Sup.hasToc = NIM_TRUE;
	asgnRef((void**) (&(*g).doc), d);
	result = &g->Sup;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, processNode__89cQsBb9a40vsSUZ26PjkTPQ_2)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg* g;
	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	result = n;
	g = ((tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*) (c));
	{
		...
		LA8_: ;
		if (!T3_) goto LA9_;
		generateDoc__KoQU28HwEVx1pDp3hXeOpg((*g).doc, n, n, ((tyEnum_DocFlags__n80LVfoJIDYz0UaY4RmOog) 0));
	}
	LA9_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, close__GrB9cG0YoTacDwWggL1RK7g_2)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	...
	useWarning = !((((*(*g).module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 13))&63U)))!=0));
	{
		...
		LA8_: ;
		if (!T3_) goto LA9_;
		writeOutput__7W8HhP9cLoIdLMqjvSJvHmg((*g).doc, useWarning);
...
NTI__QzRwKNjgUGyiY7E27E59ayg_.size = sizeof(tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg);
NTI__QzRwKNjgUGyiY7E27E59ayg_.kind = 17;
NTI__QzRwKNjgUGyiY7E27E59ayg_.base = (&NTI__Hb6rFM0ecvtlLf2kv9aU75w_);
...
TM__87tQLGE73DKq5cz9cph1IqQ_0[1].typ = (&NTI__ZoZ1pRtzmEiOBBpTrqMZHA_);
...
TM__87tQLGE73DKq5cz9cph1IqQ_0[2].typ = (&NTI__K9bspPztfoWajecnwjyHuYQ_);
...
TM__87tQLGE73DKq5cz9cph1IqQ_0[3].typ = (&NTI__a8lycfSA25OQltN3OMeBsA_);
...
NTI__QzRwKNjgUGyiY7E27E59ayg_.node = &TM__87tQLGE73DKq5cz9cph1IqQ_0[0];
NTI__IvUIgn2r9aXG5PmmODg7iBg_.size = sizeof(tyObject_TGen__QzRwKNjgUGyiY7E27E59ayg*);
NTI__IvUIgn2r9aXG5PmmODg7iBg_.kind = 22;
NTI__IvUIgn2r9aXG5PmmODg7iBg_.base = (&NTI__QzRwKNjgUGyiY7E27E59ayg_);
NTI__IvUIgn2r9aXG5PmmODg7iBg_.marker = Marker_tyRef__IvUIgn2r9aXG5PmmODg7iBg;
}
