			...
			LA35_: ;
			{
				while (1) {
					...
					res = sigtimedwait((&nmask), (&sinfo), (&tmspec));
					{
						...
						LA46_: ;
						{
							NI volatile diffX60gensym420227_;
							struct timespec bX60gensym420228_;
							{
								int T57_;
								NI32 T60_;
								T57_ = (int)0;
							...
							LA58_: ;
							diffX60gensym420227_ = (NI)0;
							nimZeroMem((void*)(&bX60gensym420228_), sizeof(struct timespec));
							bX60gensym420228_.tv_sec = enspec.tv_sec;
							bX60gensym420228_.tv_nsec = enspec.tv_nsec;
							...
							{
								{
									tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* volatile eX60gensym420238_;
									NimStringDesc* T70_;
									if (!(enspec.tv_sec == ((long) 0))) goto LA68_;
									eX60gensym420238_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
									eX60gensym420238_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
									(*eX60gensym420238_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
									(*eX60gensym420238_).Sup.Sup.name = "ValueError";
									T70_ = (NimStringDesc*)0;
									T70_ = (*eX60gensym420238_).Sup.Sup.message; (*eX60gensym420238_).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_17));
									if (T70_) nimGCunrefNoCycle(T70_);
									asgnRef((void**) (&(*eX60gensym420238_).Sup.Sup.parent), NIM_NIL);
									raiseExceptionEx((Exception*)eX60gensym420238_, "ValueError", "waitForExit", "osproc.nim", 1191);
								}
								goto LA66_;
								LA68_: ;
								{
									diffX60gensym420227_ = (NI)(stspec.tv_nsec - enspec.tv_nsec);
									enspec.tv_nsec = (NI)(((NI) 1000000000) - diffX60gensym420227_);
								}
								LA66_: ;
							}
							LA61_: ;
							...
							LA74_: ;
							{
								...
								diffX60gensym420227_ = (NI)(enspec.tv_nsec - tmspec.tv_nsec);
								tmspec.tv_nsec = (NI)(((NI) 1000000000) - diffX60gensym420227_);
							}
							LA72_: ;
							stspec.tv_sec = bX60gensym420228_.tv_sec;
							stspec.tv_nsec = bX60gensym420228_.tv_nsec;
						}
						LA44_: ;
					}
					goto LA40_;
					LA42_: ;
					{
						...
						{
							NI volatile diffX60gensym420423_;
							struct timespec bX60gensym420424_;
							...
							LA87_: ;
							diffX60gensym420423_ = (NI)0;
							nimZeroMem((void*)(&bX60gensym420424_), sizeof(struct timespec));
							bX60gensym420424_.tv_sec = enspec.tv_sec;
							bX60gensym420424_.tv_nsec = enspec.tv_nsec;
							enspec.tv_sec = (long)(enspec.tv_sec - stspec.tv_sec);
							{
							...
							{
								{
									tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* volatile eX60gensym420434_;
									NimStringDesc* T99_;
									if (!(enspec.tv_sec == ((long) 0))) goto LA97_;
									eX60gensym420434_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
									eX60gensym420434_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
									(*eX60gensym420434_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
									(*eX60gensym420434_).Sup.Sup.name = "ValueError";
									T99_ = (NimStringDesc*)0;
									T99_ = (*eX60gensym420434_).Sup.Sup.message; (*eX60gensym420434_).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_17));
									if (T99_) nimGCunrefNoCycle(T99_);
									asgnRef((void**) (&(*eX60gensym420434_).Sup.Sup.parent), NIM_NIL);
									raiseExceptionEx((Exception*)eX60gensym420434_, "ValueError", "waitForExit", "osproc.nim", 1191);
								}
								goto LA95_;
								LA97_: ;
								{
									diffX60gensym420423_ = (NI)(stspec.tv_nsec - enspec.tv_nsec);
									enspec.tv_nsec = (NI)(((NI) 1000000000) - diffX60gensym420423_);
								}
								LA95_: ;
							}
							LA90_: ;
							...
							{
								tmspec.tv_sec = (long)(tmspec.tv_sec - ((long) 1));
								diffX60gensym420423_ = (NI)(enspec.tv_nsec - tmspec.tv_nsec);
								tmspec.tv_nsec = (NI)(((NI) 1000000000) - diffX60gensym420423_);
							}
							LA101_: ;
							stspec.tv_sec = bX60gensym420424_.tv_sec;
							stspec.tv_nsec = bX60gensym420424_.tv_nsec;
						}
						goto LA80_;
						LA82_: ;
						{
								...
								while (1) {
									...
									r = res_2;
									{
										...
										if (!T24_) goto LA26_;
										{
											NIM_BOOL T30_;
											T30_ = (NIM_BOOL)0;
											T30_ = WIFEXITED__o9b5GK70QLj9ahJeczQ2LyRg_2(status);
											if (T30_) goto LA31_;
											T30_ = WIFSIGNALED__o9b5GK70QLj9ahJeczQ2LyRg(status);
											LA31_: ;
											if (!T30_) goto LA32_;
