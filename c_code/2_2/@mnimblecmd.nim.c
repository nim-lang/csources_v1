...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__LofaeXg9cmO8pKsmWT9a9bH9bw)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	NimStringDesc* path;
	...
	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* resultX60gensym473050_;
	path = copyString(p);
	resultX60gensym473050_ = NIM_NIL;
	{
		NimStringDesc* xX60gensym473051_;
		NimStringDesc* colontmp_;
		glob_t fX60gensym336870_;
		NI resX60gensym336871_;
		int T2_;
		TSafePoint TM__asNQM9aynXXg9ccUABbReyew_10;
		xX60gensym473051_ = (NimStringDesc*)0;
		...
		fX60gensym336870_.gl_offs = ((NI) 0);
		fX60gensym336870_.gl_pathc = ((NI) 0);
		...
		if (TM__asNQM9aynXXg9ccUABbReyew_10.status == 0) {
			{
				...
				{
					NI iX60gensym336876_;
					NI colontmp__2;
					NI res;
					iX60gensym336876_ = (NI)0;
					colontmp__2 = (NI)0;
					colontmp__2 = (NI)(fX60gensym336870_.gl_pathc - ((NI) 1));
					res = ((NI) 0);
					{
						while (1) {
							...
							pathX60gensym336877_ = cstrToNimstr(fX60gensym336870_.gl_pathv[iX60gensym336876_]);
							{
								...
								xX60gensym473051_ = pathX60gensym336877_;
								resultX60gensym473050_ = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(resultX60gensym473050_), (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_));
								T15_ = resultX60gensym473050_->Sup.len++;
								T16_ = (NimStringDesc*)0;
								T16_ = resultX60gensym473050_->data[T15_]; resultX60gensym473050_->data[T15_] = copyStringRC1(xX60gensym473051_);
	...
	nimbleLinks = resultX60gensym473050_;
	{
		NI T21_;
