...
N_LIB_PRIVATE N_NIMCALL(void, insert__SkQFYQfy9bAn5ELYosTsbiA)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ** x, NimStringDesc* item, NI i);
...
N_LIB_PRIVATE N_NIMCALL(void, addPath__yQoptEnH9cvj9cZKgjcndthg)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* path, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	{
		...
		if (!!(T3_)) goto LA4_;
		insert__SkQFYQfy9bAn5ELYosTsbiA((&(*conf).searchPaths), path, ((NI) 0));
	}
	LA4_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__LofaeXg9cmO8pKsmWT9a9bH9bw)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	NimStringDesc* path;
	...
	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* resultX60gensym475050_;
	path = copyString(p);
	resultX60gensym475050_ = NIM_NIL;
	{
		NimStringDesc* xX60gensym475051_;
		NimStringDesc* colontmp_;
		tyObject_WIN32_FIND_DATA__aYwmSz9bIz0JHAL9ciwIrnhA fX60gensym341670_;
		NI resX60gensym341671_;
		xX60gensym475051_ = (NimStringDesc*)0;
		colontmp_ = (NimStringDesc*)0;
		colontmp_ = slash___gEyhbzZ1UcxyenWRLJRXNQ(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_8));
		nimZeroMem((void*)(&fX60gensym341670_), sizeof(tyObject_WIN32_FIND_DATA__aYwmSz9bIz0JHAL9ciwIrnhA));
		resX60gensym341671_ = (NI)0;
		resX60gensym341671_ = findFirstFile__p19a4B9bdPpNH4m9crzgIRxwQ(colontmp_, (&fX60gensym341670_));
		{
			TSafePoint TM__asNQM9aynXXg9ccUABbReyew_9;
			if (!!((resX60gensym341671_ == ((NI) -1)))) goto LA4_;
			...
			if (TM__asNQM9aynXXg9ccUABbReyew_9.status == 0) {
				NI dotPosX60gensym341672_;
				dotPosX60gensym341672_ = searchExtPos__sw9aya5BvknC6WiJX9aEYn9ag(colontmp_);
				{
					while (1) {
						{
							NIM_BOOL T11_;
							NIM_BOOL T12_;
							NimStringDesc* ffX60gensym341673_;
							NI idxX60gensym341674_;
							T11_ = (NIM_BOOL)0;
							T12_ = (NIM_BOOL)0;
							T12_ = skipFindData__BChi31TOd3cqBpV2G8t9bAwos((&fX60gensym341670_));
							T11_ = !(T12_);
							if (!(T11_)) goto LA13_;
							T11_ = NIM_TRUE;
							LA13_: ;
							if (!T11_) goto LA14_;
							ffX60gensym341673_ = dollar___NleKxkskBzDhxdrvP1WL7A(((NI16*) ((&fX60gensym341670_.cFileName[(((NI) 0))- 0]))));
							idxX60gensym341674_ = (NI)((NI)((ffX60gensym341673_ ? ffX60gensym341673_->Sup.len : 0) - (colontmp_ ? colontmp_->Sup.len : 0)) + dotPosX60gensym341672_);
							{
								NIM_BOOL T18_;
								NIM_BOOL T19_;
								NIM_BOOL T20_;
								...
								T19_ = (NIM_BOOL)0;
								T20_ = (NIM_BOOL)0;
								T20_ = (dotPosX60gensym341672_ < ((NI) 0));
								if (T20_) goto LA21_;
								T20_ = ((ffX60gensym341673_ ? ffX60gensym341673_->Sup.len : 0) <= idxX60gensym341674_);
								LA21_: ;
								T19_ = T20_;
								if (T19_) goto LA22_;
								T23_ = (NIM_BOOL)0;
								T23_ = (((NI) 0) <= idxX60gensym341674_);
								if (!(T23_)) goto LA24_;
								T23_ = ((NU8)(ffX60gensym341673_->data[idxX60gensym341674_]) == (NU8)(46));
								LA24_: ;
								T19_ = T23_;
								LA22_: ;
								T18_ = T19_;
								...
								T26_ = (NIM_BOOL)0;
								T27_ = (NIM_BOOL)0;
								T27_ = (((NI) 0) <= dotPosX60gensym341672_);
								if (!(T27_)) goto LA28_;
								T27_ = ((NI)(dotPosX60gensym341672_ + ((NI) 1)) < (colontmp_ ? colontmp_->Sup.len : 0));
								LA28_: ;
								T26_ = T27_;
								if (!(T26_)) goto LA29_;
								T26_ = ((NU8)(colontmp_->data[(NI)(dotPosX60gensym341672_ + ((NI) 1))]) == (NU8)(42));
								LA29_: ;
								T18_ = T26_;
								LA25_: ;
								if (!T18_) goto LA30_;
								...
								T33_ = nosextractFilename(ffX60gensym341673_);
								xX60gensym475051_ = slash___gEyhbzZ1UcxyenWRLJRXNQ(T32_.Field0, T33_);
								resultX60gensym475050_ = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(resultX60gensym475050_), (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_));
								T34_ = resultX60gensym475050_->Sup.len++;
								T35_ = (NimStringDesc*)0;
								T35_ = resultX60gensym475050_->data[T34_]; resultX60gensym475050_->data[T34_] = copyStringRC1(xX60gensym475051_);
						...
						{
							NI32 T38_;
							NI32 errCodeX60gensym341675_;
							T38_ = (NI32)0;
							T38_ = Dl_299462_(resX60gensym341671_, (&fX60gensym341670_));
							if (!(T38_ == ((NI32) 0))) goto LA39_;
							errCodeX60gensym341675_ = Dl_298830_();
							{
								if (!(errCodeX60gensym341675_ == ((NI32) 18))) goto LA43_;
								goto LA7;
							}
							goto LA41_;
							LA43_: ;
							{
								raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(errCodeX60gensym341675_, ((NimStringDesc*) NIM_NIL));
							}
							LA41_: ;
						}
						LA39_: ;
			...
			{
				Dl_299614_(resX60gensym341671_);
			}
			if (TM__asNQM9aynXXg9ccUABbReyew_9.status != 0) reraiseException();
		}
		LA4_: ;
	}
	nimbleLinks = resultX60gensym475050_;
	{
		NI T50_;
	...
	LA51_: ;
	{
		...
		insert__SkQFYQfy9bAn5ELYosTsbiA((&(*conf).lazyPaths), path, ((NI) 0));
	}
	LA62_: ;
}
