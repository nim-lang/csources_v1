...
tyProc__oew1DfaGl5XhHmnBK0HYXQ Dl_383321_;
tyProc__uryidYWkntM7ddjZSyxvyQ Dl_383331_;
tyProc__vjGHiWUJwFzOgSxDffBb6Q Dl_383333_;
extern tyObject_GcHeap__1TRH1TZMaVZTnLNcIHuNFQ gch__IcYaEuuWivYAS86vFMTS3Q;
tyProc__oPCjp4xTgEl9a8fqSzOv8lw Dl_383518_;
...
N_LIB_PRIVATE N_NIMCALL(void, initTerminal__pedJmwzZhBZ3Plges9cE1og)(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* term) {	NI hStdoutTemp;
	...
	hStdoutTemp = Dl_298820_(((NI32) -11));
	{
		...
		T4_ = Dl_383331_();
		T5_ = (NI32)0;
		T5_ = Dl_383321_(T3_, hStdoutTemp, T4_, (&(*term).hStdout), ((NI32) 0), ((NI32) 1), ((NI32) 2));
	...
	hStderrTemp = Dl_298820_(((NI32) -12));
	{
		...
		T11_ = Dl_383331_();
		T12_ = (NI32)0;
		T12_ = Dl_383321_(T10_, hStderrTemp, T11_, (&(*term).hStderr), ((NI32) 0), ((NI32) 1), ((NI32) 2));
...
N_LIB_PRIVATE N_NIMCALL(void, setStyle__y8lW2LrW2n5ZHaxH9bAf4WA)(FILE* f, tySet_tyEnum_Style__NXKayqTLMsAibFwNceBlpA style) {	NI h;
	tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* termX60gensym388001_;
	NI16 old;
	NI16 T6_;
	NI16 a;
	NI32 T23_;
	termX60gensym388001_ = getTerminal__eaf5C0KoL9blsRnH3dpKg9cAterminal();
	{
		if (!(f == stderr)) goto LA3_;
		h = (*termX60gensym388001_).hStderr;
	}
	goto LA1_;
	LA3_: ;
	{
		h = (*termX60gensym388001_).hStdout;
	}
	LA1_: ;
	T6_ = (NI16)0;
...
N_LIB_PRIVATE N_NIMCALL(void, resetAttributes__6J8xlU57R8cS9bLzTS89aM5g)(FILE* f) {	tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* term;
	term = getTerminal__eaf5C0KoL9blsRnH3dpKg9cAterminal();
	{
		...
		if (!(f == stderr)) goto LA3_;
		T5_ = (NI32)0;
		T5_ = Dl_383518_((*term).hStderr, (*term).oldStderrAttr);
		(void)(T5_);
	}
	goto LA1_;
	LA3_: ;
	{
		NI32 T7_;
		T7_ = (NI32)0;
		T7_ = Dl_383518_((*term).hStdout, (*term).oldStdoutAttr);
		(void)(T7_);
	}
	LA1_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, setForegroundColor__vJutklhcnQq9akCXxcuSHAg)(FILE* f, tyEnum_ForegroundColor__ez9ah4IgQc0AbdW68acioDg fg, NIM_BOOL bright) {	NI h;
	tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* termX60gensym388601_;
	NI16 old;
	NI16 T6_;
	termX60gensym388601_ = getTerminal__eaf5C0KoL9blsRnH3dpKg9cAterminal();
	{
		if (!(f == stderr)) goto LA3_;
		h = (*termX60gensym388601_).hStderr;
	}
	goto LA1_;
	LA3_: ;
	{
		h = (*termX60gensym388601_).hStdout;
	}
	LA1_: ;
	T6_ = (NI16)0;
	T6_ = getAttributes__DruuydPLPxoaQzMTah2aEA(h);
...
if (!((TM__CN3raB9atujkEiPpxYAdlgQ_4 = nimLoadLibrary(((NimStringDesc*) &TM__CN3raB9atujkEiPpxYAdlgQ_6)))
	...
	Dl_383321_ = (tyProc__oew1DfaGl5XhHmnBK0HYXQ) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "DuplicateHandle");
	Dl_383331_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "GetCurrentProcess");
	Dl_383333_ = (tyProc__vjGHiWUJwFzOgSxDffBb6Q) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "GetConsoleScreenBufferInfo");
	Dl_383518_ = (tyProc__oPCjp4xTgEl9a8fqSzOv8lw) nimGetProcAddr(TM__CN3raB9atujkEiPpxYAdlgQ_4, "SetConsoleTextAttribute");
}
