...
TNimType NTI__Tyd4y3haUOOHTj71TPIRag_;
TNimType NTI__4HwedE75WPfqZSQ0Cq2OUg_;
N_LIB_PRIVATE N_NIMCALL(NI, ord__N9bsHhIEUMfKbgZ9aJBy6m2A)(NI16 arg) {	NI result;
	result = (NI)0;
	result = ((NI) (((NU16) (arg))));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___NmQ9ct6KsQm3mcX4z6BEBbA)(NI16* w, NI estimate, NI replacement) {	NimStringDesc* result;
	NI i;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___NleKxkskBzDhxdrvP1WL7A)(NI16* s) {	NimStringDesc* result;
	result = (NimStringDesc*)0;
...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString__K8rR70TBwrP6FNBzDhVVOA)(NCSTRING source, NI L) {	NI16* result;
	NI d;
	result = (NI16*)0;
...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString__G8rSmf9akUNUzuZWlrfFAmA)(NCSTRING s) {	NI16* result;
{	result = (NI16*)0;
	{
		if (!(s == 0)) goto LA3_;
		result = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString__rFkWhJjmVi0m0Hc9agVEZIQ)(NimStringDesc* s) {	NI16* result;
	result = (NI16*)0;
