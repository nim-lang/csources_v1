...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__LofaeXg9cmO8pKsmWT9a9bH9bw)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	NimStringDesc* path;
	...
	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* resultX60gensym474050_;
	path = copyString(p);
	resultX60gensym474050_ = NIM_NIL;
	{
		NimStringDesc* xX60gensym474051_;
		NimStringDesc* colontmp_;
		glob_t fX60gensym338870_;
		NI resX60gensym338871_;
		int T2_;
		TSafePoint TM__asNQM9aynXXg9ccUABbReyew_10;
		xX60gensym474051_ = (NimStringDesc*)0;
		...
		TM__asNQM9aynXXg9ccUABbReyew_10.status = _setjmp(TM__asNQM9aynXXg9ccUABbReyew_10.context);
					...
					res = ((NI) 0);
					{
						while (1) {
							...
							pathX60gensym338877_ = cstrToNimstr(fX60gensym338870_.gl_pathv[iX60gensym338876_]);
							{
								...
								xX60gensym474051_ = pathX60gensym338877_;
								resultX60gensym474050_ = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(resultX60gensym474050_), (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_));
								T15_ = resultX60gensym474050_->Sup.len++;
								T16_ = (NimStringDesc*)0;
								T16_ = resultX60gensym474050_->data[T15_]; resultX60gensym474050_->data[T15_] = copyStringRC1(xX60gensym474051_);
	...
	nimbleLinks = resultX60gensym474050_;
	{
		NI T21_;
