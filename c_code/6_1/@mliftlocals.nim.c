...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w*, lookupParam__XJudyjSIbAQSzxP19bffS8A)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* params, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* dest) {	tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* result;
		...
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = ((*(*params).sons->data[i]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3));
					if (!(T10_)) goto LA11_;
...
static N_INLINE(NIM_BOOL, interestingVar__ISRlamvcJhcnDvn0K9aiZPQliftlocals)(tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* s) {	NIM_BOOL result;
	NIM_BOOL T1_;
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, lookupOrAdd__n6xVDBYbDiXGgZPQefdKGg)(tyObject_Ctx__A9b2QU9aJFjQJmSPHiXNYt7g* c, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* s, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
...
N_LIB_PRIVATE N_NIMCALL(void, liftLocals__UcDN5YNBelL9bXFeLvxzn7Q)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NI i, tyObject_Ctx__A9b2QU9aJFjQJmSPHiXNYt7g* c) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* it;
	it = (*n).sons->data[i];
	switch ((*it).kind) {
	...
	{
		{
			NIM_BOOL T4_;
			T4_ = (NIM_BOOL)0;
			T4_ = interestingVar__ISRlamvcJhcnDvn0K9aiZPQliftlocals((*it).sym);
			if (!T4_) goto LA5_;
			asgnRef((void**) (&(*n).sons->data[i]), lookupOrAdd__n6xVDBYbDiXGgZPQefdKGg(c, (*it).sym, (*it).info));
		}
		LA5_: ;
	}
	break;
...
{	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	liftDest = getPragmaVal__fMcQjyT1dTz2fXfUKJSCCA((*prc).ast, ((tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw) 207));
	{
