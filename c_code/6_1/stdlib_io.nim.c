...
NIM_CONST tyArray__XL8FfPqMNtuU56fW9c8pBtQ FormatOpen__iWZDMxVvD1FETfmW09b8gFQ = {((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_6),
...
N_LIB_PRIVATE N_NOINLINE(void, raiseEIO__ZYk14k3sVNZUIjJjtqzFZQ)(NimStringDesc* msg) {	tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym169224_;
	NimStringDesc* T1_;
	eX60gensym169224_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
	eX60gensym169224_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
	(*eX60gensym169224_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
	(*eX60gensym169224_).Sup.Sup.name = "IOError";
	T1_ = (NimStringDesc*)0;
	T1_ = (*eX60gensym169224_).Sup.Sup.message; (*eX60gensym169224_).Sup.Sup.message = copyStringRC1(msg);
	if (T1_) nimGCunrefNoCycle(T1_);
	asgnRef((void**) (&(*eX60gensym169224_).Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym169224_, "IOError", "raiseEIO", "io.nim", 132);
}
N_LIB_PRIVATE N_NIMCALL(void, checkErr__fU6ZlJAtQ9bre04EDZLdGsA)(FILE* f) {	{
		int T3_;
		NimStringDesc* msg;
...
N_LIB_PRIVATE N_NIMCALL(NI, writeBuffer__f3MIZh4IV2qRTxlOpckbRA)(FILE* f, void* buffer, NI len) {	NI result;
	int T1_;
	result = (NI)0;
	T1_ = (int)0;
...
N_LIB_PRIVATE N_NIMCALL(void, write__PArlm09bKklm2BLsCg6YtaA)(FILE* f, NimStringDesc* s) {	{
		NI T3_;
		T3_ = (NI)0;
		T3_ = writeBuffer__f3MIZh4IV2qRTxlOpckbRA(f, ((void*) (nimToCStringConv(s))), ((NI) ((s ? s->Sup.len : 0))));
...
N_LIB_PRIVATE N_NIMCALL(FILE*, open__cb1k9citqyT9a9brBSJAz8pkg)(NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {	FILE* result;
	...
	{
		NIM_BOOL T3_;
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym172500_;
		NimStringDesc* T6_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&result, filename, mode, bufSize);
		if (!!(T3_)) goto LA4_;
		eX60gensym172500_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym172500_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym172500_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym172500_).Sup.Sup.name = "IOError";
		T6_ = (NimStringDesc*)0;
...
appendString(T6_, filename);
		asgnRef((void**) (&(*eX60gensym172500_).Sup.Sup.message), T6_);
		asgnRef((void**) (&(*eX60gensym172500_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym172500_, "IOError", "open", "io.nim", 572);
	}
	LA4_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, readBuffer__f3MIZh4IV2qRTxlOpckbRA_2)(FILE* f, void* buffer, NI len) {	NI result;
	result = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllBuffer__mQf9blHFlTwuSvJjirhpY6g_2)(FILE* file) {	NimStringDesc* result;
	...
	buffer = mnewString(((NI) 4000));
	{
		while (1) {
			NI bytesRead;
			bytesRead = readBuffer__f3MIZh4IV2qRTxlOpckbRA_2(file, ((void*) ((&buffer->data[((NI) 0)]))), ((NI) 4000));
			{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile__W4tKfHpbz7kHhikLsBc0EA)(FILE* file, NI64 len) {	NimStringDesc* result;
	...
	bytes = readBuffer__f3MIZh4IV2qRTxlOpckbRA_2(file, ((void*) ((&result->data[((NI) 0)]))), ((NI) (len)));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile__4PGnM9bWmsH0Nu7dnr3XzgA)(NimStringDesc* filename) {	NimStringDesc* volatile result;
	...
	f = (FILE*)0;
	{
		...
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_12.status = _setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_12.context);
	...
	LA4_: ;
	{
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym175222_;
		NimStringDesc* T10_;
		eX60gensym175222_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym175222_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym175222_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym175222_).Sup.Sup.name = "IOError";
...
appendString(T10_, filename);
		asgnRef((void**) (&(*eX60gensym175222_).Sup.Sup.message), T10_);
		asgnRef((void**) (&(*eX60gensym175222_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym175222_, "IOError", "readFile", "io.nim", 676);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NOINLINE(void, raiseEOF__CA1KPE9bDgvXVjqamZd5T9bQ)(void) {	tyObject_EOFError__KGSY1JdrNB7Xi8KDhXFhSg* eX60gensym169457_;
	NimStringDesc* T1_;
	eX60gensym169457_ = (tyObject_EOFError__KGSY1JdrNB7Xi8KDhXFhSg*)0;
	eX60gensym169457_ = (tyObject_EOFError__KGSY1JdrNB7Xi8KDhXFhSg*) newObj((&NTI__LEclZrWX2FQAodlapxGITw_), sizeof(tyObject_EOFError__KGSY1JdrNB7Xi8KDhXFhSg));
	(*eX60gensym169457_).Sup.Sup.Sup.Sup.m_type = (&NTI__KGSY1JdrNB7Xi8KDhXFhSg_);
	(*eX60gensym169457_).Sup.Sup.Sup.name = "EOFError";
	T1_ = (NimStringDesc*)0;
	T1_ = (*eX60gensym169457_).Sup.Sup.Sup.message; (*eX60gensym169457_).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_13));
	if (T1_) nimGCunrefNoCycle(T1_);
	asgnRef((void**) (&(*eX60gensym169457_).Sup.Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym169457_, "EOFError", "raiseEOF", "io.nim", 135);
}
...
N_LIB_PRIVATE N_NIMCALL(void, writeFile__D6Pj9c29aCLEJP9beOWa08HYA)(NimStringDesc* filename, NimStringDesc* content) {	FILE* f;
	...
	{
		NIM_BOOL T3_;
		TSafePoint TM__MnCJ0VAmeZ9aTATUB39cx60Q_14;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) -1));
		if (!T3_) goto LA4_;
		pushSafePoint(&TM__MnCJ0VAmeZ9aTATUB39cx60Q_14);
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_14.status = _setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_14.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_14.status == 0) {
	...
	LA4_: ;
	{
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym175434_;
		NimStringDesc* T10_;
		eX60gensym175434_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym175434_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym175434_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym175434_).Sup.Sup.name = "IOError";
		T10_ = (NimStringDesc*)0;
		T10_ = rawNewString((filename ? filename->Sup.len : 0) + 13);
appendString(T10_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_11));
appendString(T10_, filename);
		asgnRef((void**) (&(*eX60gensym175434_).Sup.Sup.message), T10_);
		asgnRef((void**) (&(*eX60gensym175434_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym175434_, "IOError", "writeFile", "io.nim", 689);
	}
	LA1_: ;
}
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, readLines__UgG9cRBA8hHA9aJABIdHeQyw)(NimStringDesc* filename, NI n) {	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* volatile result;
	...
	f = (FILE*)0;
	{
		...
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status = _setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.context);
	...
	LA4_: ;
	{
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym175680_;
		NimStringDesc* T18_;
		eX60gensym175680_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym175680_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym175680_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym175680_).Sup.Sup.name = "IOError";
...
appendString(T18_, filename);
		asgnRef((void**) (&(*eX60gensym175680_).Sup.Sup.message), T18_);
		asgnRef((void**) (&(*eX60gensym175680_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym175680_, "IOError", "readLines", "io.nim", 707);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__NY67RvH2AlO9b9a83QFwNNag)(FILE** f, int filehandle, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode) {	NIM_BOOL result;
	result = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, setFilePos__FA7rp0y5drPpfGuceb3IJg)(FILE* f, NI64 pos, tyEnum_FileSeekPos__I9aQjuvWxs8BspGbxwsngWw relativeTo) {	{
		...
		if (!!((T3_ == ((NI32) 0)))) goto LA4_;
		raiseEIO__ZYk14k3sVNZUIjJjtqzFZQ(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_16));
	}
	LA4_: ;
}
