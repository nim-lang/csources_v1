...
TNimType NTI__qtqsWM5aXmcpMIVmvq3kAA_;
...
N_LIB_PRIVATE N_NIMCALL(void, md5Init__aFJbJ6Fb5boL1UBjNazO4A)(tyObject_MD5Context__oMciKUdSdCaIeMtcxbiPOw* c) {	(*c).state[(((NI) 0))- 0] = ((NU32) 1732584193);
	...
	zeroMem__9cLyRtoQz0YlIMEd4qW7Hdgsystem(((void*) ((*c).buffer)), ((NI) 64));
}
...
N_LIB_PRIVATE N_NIMCALL(void, encode__3XCrKZ0CpOjKYafeeVPnyw)(NU32* dest, NCSTRING src) {	NI j;
	j = ((NI) 0);
	{
		NI i;
		NI res;
...
static N_INLINE(NU32, F__junZWnvhBQX0olNRUg769cgmd5)(NU32 x, NU32 y, NU32 z) {	NU32 result;
	result = (NU32)0;
	result = (NU32)((NU32)(x & y) | (NU32)((NU32)((NU32) ~(x)) & z));
	return result;
}
static N_INLINE(void, rot__E0YQh9cqfeV9b80YVg57S1mAmd5)(NU32* x, NU8 n) {	(*x) = (NU32)((NU32)((NU32)((*x)) << (NU32)(n)) | (NU32)((NU32)((*x)) >> (NU32)((NU32)((NU32)(((NU32) 32)) - (NU32)(((NU32) (n)))))));
}
N_LIB_PRIVATE N_NIMCALL(void, FF__ShdGhVqwUZX4yDCc7A6Q6Q)(NU32* a, NU32 b, NU32 c, NU32 d, NU32 x, NU8 s, NU32 ac) {	NU32 T1_;
	T1_ = (NU32)0;
...
static N_INLINE(NU32, G__junZWnvhBQX0olNRUg769cg_2md5)(NU32 x, NU32 y, NU32 z) {	NU32 result;
	result = (NU32)0;
	result = (NU32)((NU32)(x & z) | (NU32)(y & (NU32)((NU32) ~(z))));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, GG__ShdGhVqwUZX4yDCc7A6Q6Q_2)(NU32* a, NU32 b, NU32 c, NU32 d, NU32 x, NU8 s, NU32 ac) {	NU32 T1_;
	T1_ = (NU32)0;
...
static N_INLINE(NU32, H__junZWnvhBQX0olNRUg769cg_3md5)(NU32 x, NU32 y, NU32 z) {	NU32 result;
	result = (NU32)0;
	result = (NU32)((NU32)(x ^ y) ^ z);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, HH__ShdGhVqwUZX4yDCc7A6Q6Q_3)(NU32* a, NU32 b, NU32 c, NU32 d, NU32 x, NU8 s, NU32 ac) {	NU32 T1_;
	T1_ = (NU32)0;
...
static N_INLINE(NU32, I__junZWnvhBQX0olNRUg769cg_4md5)(NU32 x, NU32 y, NU32 z) {	NU32 result;
	result = (NU32)0;
	result = (NU32)(y ^ (NU32)(x | (NU32)((NU32) ~(z))));
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, II__ShdGhVqwUZX4yDCc7A6Q6Q_4)(NU32* a, NU32 b, NU32 c, NU32 d, NU32 x, NU8 s, NU32 ac) {	NU32 T1_;
	T1_ = (NU32)0;
...
N_LIB_PRIVATE N_NIMCALL(void, transform__FpyLDebN7eBB2pkKKmjXJg)(void* buffer, NU32* state) {	tyArray__U0SiHM0pVagA9c71oWelQMA myBlock;
	NU32 a;
	NU32 b;
	NU32 c;
	NU32 d;
...
N_LIB_PRIVATE N_NIMCALL(void, md5Update__3dyWcdKqKqoei9csU09cRuCA)(tyObject_MD5Context__oMciKUdSdCaIeMtcxbiPOw* c, NCSTRING input, NI len) {	NCSTRING input_2;
	NI Index;
	NI PartLen;
	input_2 = input;
	...
	PartLen = (NI)(((NI) 64) - Index);
	{
		...
		copyMem__M04YC71iJg1N7gBF3HZTngsystem(((void*) ((&(*c).buffer[(Index)- 0]))), ((void*) (input_2)), ((NI) (PartLen)));
		...
		copyMem__M04YC71iJg1N7gBF3HZTngsystem(((void*) ((&(*c).buffer[(((NI) 0))- 0]))), ((void*) ((&input_2[i]))), ((NI) ((NI)(len - i))));
	}
	goto LA5_;
	LA7_: ;
	{
		copyMem__M04YC71iJg1N7gBF3HZTngsystem(((void*) ((&(*c).buffer[(Index)- 0]))), ((void*) ((&input_2[((NI) 0)]))), ((NI) (len)));
	}
	LA5_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, decode__qtGCMfOlZdT3LJ4HIRsaNA)(NU8* dest, NI destLen_0, NU32* src, NI srcLen_0) {	NI i;
	i = ((NI) 0);
	{
		NI j;
		NI colontmp_;
...
N_LIB_PRIVATE N_NIMCALL(void, md5Final__CQoglTaDBxWEuKEO9ah9bXuQ)(tyObject_MD5Context__oMciKUdSdCaIeMtcxbiPOw* c, NU8* digest) {	tyArray__cdsir9aPB24hAk6k77P9b9bCA Bits;
	NI PadLen;
	NI Index;
...
"\000", PadLen);
	...
	zeroMem__9cLyRtoQz0YlIMEd4qW7Hdgsystem(((void*) (c)), ((NI) 88));
}
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___bUodBpefvLgLc2LbngPSqw)(tyArray__qtqsWM5aXmcpMIVmvq3kAA d) {	NimStringDesc* result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getMD5__kEzF9cC2zt4kZNszZVUnKEA)(NimStringDesc* s) {	NimStringDesc* result;
