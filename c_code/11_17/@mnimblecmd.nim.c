...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__LofaeXg9cmO8pKsmWT9a9bH9bw)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	NimStringDesc* path;
	...
	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* resultX60gensym472050_;
	path = copyString(p);
	resultX60gensym472050_ = NIM_NIL;
	{
		NimStringDesc* xX60gensym472051_;
		NimStringDesc* colontmp_;
		glob_t fX60gensym336870_;
		NI resX60gensym336871_;
		int T2_;
		TSafePoint TM__asNQM9aynXXg9ccUABbReyew_10;
		xX60gensym472051_ = (NimStringDesc*)0;
		colontmp_ = (NimStringDesc*)0;
		colontmp_ = slash___gEyhbzZ1UcxyenWRLJRXNQ(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_9));
		nimZeroMem((void*)(&fX60gensym336870_), sizeof(glob_t));
		resX60gensym336871_ = (NI)0;
		fX60gensym336870_.gl_offs = ((int) 0);
		fX60gensym336870_.gl_pathc = ((int) 0);
		fX60gensym336870_.gl_pathv = NIM_NIL;
		T2_ = (int)0;
		T2_ = glob(nimToCStringConv(colontmp_), ((int) 0), NIM_NIL, (&fX60gensym336870_));
		resX60gensym336871_ = ((NI) (T2_));
		...
		if (TM__asNQM9aynXXg9ccUABbReyew_10.status == 0) {
			{
				if (!(resX60gensym336871_ == ((NI) 0))) goto LA6_;
				{
					NI32 iX60gensym336876_;
					NI32 colontmp__2;
					NI32 res;
					iX60gensym336876_ = (NI32)0;
					colontmp__2 = (NI32)0;
					colontmp__2 = (NI32)(fX60gensym336870_.gl_pathc - ((NI32) 1));
					res = ((NI32) 0);
					{
						while (1) {
							NimStringDesc* pathX60gensym336877_;
							if (!(res <= colontmp__2)) goto LA10;
							iX60gensym336876_ = res;
							pathX60gensym336877_ = cstrToNimstr(fX60gensym336870_.gl_pathv[iX60gensym336876_]);
							{
								NI T15_;
								NimStringDesc* T16_;
								if (!NIM_TRUE) goto LA13_;
								xX60gensym472051_ = pathX60gensym336877_;
								resultX60gensym472050_ = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(resultX60gensym472050_), (&NTI__sM4lkSb7zS6F7OVMvW9cffQ_));
								T15_ = resultX60gensym472050_->Sup.len++;
								T16_ = (NimStringDesc*)0;
								T16_ = resultX60gensym472050_->data[T15_]; resultX60gensym472050_->data[T15_] = copyStringRC1(xX60gensym472051_);
		...
		{
			globfree((&fX60gensym336870_));
		}
		if (TM__asNQM9aynXXg9ccUABbReyew_10.status != 0) reraiseException();
	}
	nimbleLinks = resultX60gensym472050_;
	{
		NI T21_;
