...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux__uUUlW19bGNZxGHYYme2pM8A)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___TtzOadDB4I9a89cWej19a2PNg)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent___KKiSvh9a121M0uSQjcJhhMg)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
TNimType NTI__4jLZHF07vYxUK3tt7TCvdA_;
...
TNimType NTI__RAhtsUA2w9btaU8K3v0RQAg_;
extern tyObject_GcHeap__1TRH1TZMaVZTnLNcIHuNFQ gch__IcYaEuuWivYAS86vFMTS3Q;
extern TNimType NTI__ytyiCJqK439aF9cIibuRVpAg_;
TNimType NTI__Wif8sNhW63ukfJmVEqpOVw_;
extern TNimType NTI__4hi0XQqK9aLiPuWT9acsXm9aQ_;
TNimType NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_;
STRING_LITERAL(TM__yPaXWsjYzX34ek6cfhmMUw_3, "dot", 3);
static N_NIMCALL(void, Marker_tyRef__RAhtsUA2w9btaU8K3v0RQAg)(void* p, NI op) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpen__9aBBHcC5JwGAhBYrKj64M6g)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__JpsEh5i1AcKChGYbg7aV4w* module) {	tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* result;
	...
	g = (tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*) newObj((&NTI__RAhtsUA2w9btaU8K3v0RQAg_), sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA));
	(*g).Sup.Sup.m_type = (&NTI__4jLZHF07vYxUK3tt7TCvdA_);
	...
	asgnRef((void**) (&(*g).graph), graph);
	{
		...
		T5_ = (tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*) newObj((&NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_), sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw));
...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux__uUUlW19bGNZxGHYYme2pM8A)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported) {	tyArray__mrugoXXRZUEeG9bEXo9auBKw T1_;
	tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* T2_;
	nimZeroMem((void*)T1_, sizeof(tyArray__mrugoXXRZUEeG9bEXo9auBKw));
	T1_[0] = rope__yShmEg9cffWxI7s5XzEKBow(importing);
	T1_[1] = rope__yShmEg9cffWxI7s5XzEKBow(imported);
	T2_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T2_ = percent___TtzOadDB4I9a89cWej19a2PNg(T1_, 2);
	add__IM4kcMNkkOLJtqdEqSxR8A(&(*b).dotGraph, T2_);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, addDotDependency__8wExOQ8P7cmaE9bvpwwGr9aA)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {	tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* result;
	tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA* g;
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					imported = getModuleName__rlFejf61X39bVziQhhH7znQ((*g).config, (*n).sons->data[i]);
					addDependencyAux__uUUlW19bGNZxGHYYme2pM8A(b, (*(*(*g).module).name).s, imported);
					i_2 += ((NI) 1);
				} LA4: ;
			}
		}
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 117):
	{
		...
		imported_2 = getModuleName__rlFejf61X39bVziQhhH7znQ((*g).config, (*n).sons->data[((NI) 0)]);
		addDependencyAux__uUUlW19bGNZxGHYYme2pM8A(b, (*(*(*g).module).name).s, imported_2);
	}
	break;
	...
	{
		{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					T10_ = addDotDependency__8wExOQ8P7cmaE9bvpwwGr9aA(c, (*n).sons->data[i_3]);
					(void)(T10_);
					i_4 += ((NI) 1);
				} LA9: ;
			}
...
N_LIB_PRIVATE N_NIMCALL(void, generateDot__PmWB9cH9aNqzmEfDVIh5xwsA)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NimStringDesc* project) {	tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b;
	...
	splitFile__z7B4FbwzX3Y0L1EA2lLGXw(project, (&T2_));
	T1_[0] = rope__yShmEg9cffWxI7s5XzEKBow(T2_.Field1);
	T1_[1] = (*b).dotGraph;
	T3_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T3_ = percent___KKiSvh9a121M0uSQjcJhhMg(T1_, 2);
	T4_ = (NimStringDesc*)0;
	T4_ = noschangeFileExt(project, ((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_3));
	T5_ = (NIM_BOOL)0;
	T5_ = writeRope__LLRRC42xWBSkxzV9bsPu7lA(T3_, T4_);
	(void)(T5_);
}
...
NTI__4jLZHF07vYxUK3tt7TCvdA_.size = sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA);
NTI__4jLZHF07vYxUK3tt7TCvdA_.kind = 17;
NTI__4jLZHF07vYxUK3tt7TCvdA_.base = (&NTI__Hb6rFM0ecvtlLf2kv9aU75w_);
...
TM__yPaXWsjYzX34ek6cfhmMUw_0[1].typ = (&NTI__K9bspPztfoWajecnwjyHuYQ_);
...
TM__yPaXWsjYzX34ek6cfhmMUw_0[2].typ = (&NTI__a8lycfSA25OQltN3OMeBsA_);
...
TM__yPaXWsjYzX34ek6cfhmMUw_0[3].typ = (&NTI__KfdHSsl8vyUCSI9b3inBcww_);
...
NTI__4jLZHF07vYxUK3tt7TCvdA_.node = &TM__yPaXWsjYzX34ek6cfhmMUw_0[0];
NTI__RAhtsUA2w9btaU8K3v0RQAg_.size = sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*);
NTI__RAhtsUA2w9btaU8K3v0RQAg_.kind = 22;
NTI__RAhtsUA2w9btaU8K3v0RQAg_.base = (&NTI__4jLZHF07vYxUK3tt7TCvdA_);
NTI__RAhtsUA2w9btaU8K3v0RQAg_.marker = Marker_tyRef__RAhtsUA2w9btaU8K3v0RQAg;
NTI__Wif8sNhW63ukfJmVEqpOVw_.size = sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw);
NTI__Wif8sNhW63ukfJmVEqpOVw_.kind = 17;
NTI__Wif8sNhW63ukfJmVEqpOVw_.base = (&NTI__ytyiCJqK439aF9cIibuRVpAg_);
...
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].typ = (&NTI__4hi0XQqK9aLiPuWT9acsXm9aQ_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].name = "dotGraph";
NTI__Wif8sNhW63ukfJmVEqpOVw_.node = &TM__yPaXWsjYzX34ek6cfhmMUw_0[4];
NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_.size = sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*);
NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_.kind = 22;
NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_.base = (&NTI__Wif8sNhW63ukfJmVEqpOVw_);
NTI__Z9cBOJWNt0CSRvLG1Nw4Uvg_.marker = Marker_tyRef__Z9cBOJWNt0CSRvLG1Nw4Uvg;
}
