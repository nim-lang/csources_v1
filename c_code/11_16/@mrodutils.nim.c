...
N_LIB_PRIVATE N_NIMCALL(void, encodeVIntAux__lNzvVCaz9agOxH6nqWMG4Ww_2)(NI x, NimStringDesc** result) {	NIM_CHAR dX60gensym555477_;
	NI vX60gensym555478_;
	NI remX60gensym555479_;
	NI idxX60gensym555480_;
	dX60gensym555477_ = (NIM_CHAR)0;
	vX60gensym555478_ = x;
	remX60gensym555479_ = (NI)(vX60gensym555478_ % ((NI) 190));
	{
		if (!(remX60gensym555479_ < ((NI) 0))) goto LA3_;
		unsureAsgnRef((void**) (&(*result)), addChar((*result), 45));
		vX60gensym555478_ = ((NI64)-((NI)(vX60gensym555478_ / ((NI) 190))));
		remX60gensym555479_ = ((NI64)-(remX60gensym555479_));
	}
	goto LA1_;
	LA3_: ;
	{
		vX60gensym555478_ = (NI)(vX60gensym555478_ / ((NI) 190));
	}
	LA1_: ;
	idxX60gensym555480_ = remX60gensym555479_;
	{
		if (!(idxX60gensym555480_ < ((NI) 62))) goto LA8_;
		dX60gensym555477_ = ((NimStringDesc*) &TM__mZLUkjbotQF2WK9bQcNKBCA_7)->data[idxX60gensym555480_];
	}
	goto LA6_;
	LA8_: ;
	{
		dX60gensym555477_ = ((NIM_CHAR) (((NI) ((NI)((NI)(idxX60gensym555480_ - ((NI) 62)) + ((NI) 128))))));
	}
	LA6_: ;
	{
		if (!!((vX60gensym555478_ == ((NI) 0)))) goto LA13_;
		encodeVIntAux__lNzvVCaz9agOxH6nqWMG4Ww_2(vX60gensym555478_, result);
	}
	LA13_: ;
	unsureAsgnRef((void**) (&(*result)), addChar((*result), dX60gensym555477_));
}
