...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		NimStringDesc* pX60gensym1153120_;
		if (!!((((*conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 15))&63U)))!=0))) goto LA8_;
		pX60gensym1153120_ = getSystemConfigPath__20ZvyukzMEoGWloXckQXaw(conf, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153120_);
			if (!T12_) goto LA13_;
			runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153120_, NIM_FALSE, conf);
		}
		LA13_: ;
	}
	LA8_: ;
	{
		NimStringDesc* pX60gensym1153128_;
		if (!!((((*conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 17))&63U)))!=0))) goto LA17_;
		pX60gensym1153128_ = getUserConfigPath__JWCVdcP9a8q9acNEgF9aYr8sA(((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
		{
			NIM_BOOL T21_;
			T21_ = (NIM_BOOL)0;
			T21_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153128_);
			if (!T21_) goto LA22_;
			runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153128_, NIM_FALSE, conf);
		}
		LA22_: ;
	}
	LA17_: ;
	{
		if (!!((((*conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 18))&63U)))!=0))) goto LA26_;
		{
			...
			colontmp_ = (*conf).projectPath;
			{
				...
				{
					NimStringDesc* pX60gensym1153137_;
					if (!NIM_FALSE) goto LA35_;
					dir = colontmp_;
					pX60gensym1153137_ = slash___QVqo5OOQAdrjFqBsPctklw(dir, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
					{
						NIM_BOOL T39_;
						T39_ = (NIM_BOOL)0;
						T39_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153137_);
						if (!T39_) goto LA40_;
						runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153137_, NIM_FALSE, conf);
					}
					LA40_: ;
				}
				LA35_: ;
				{
					while (1) {
						NimStringDesc* pX60gensym1153137__2;
						{
							NIM_BOOL T46_;
							T46_ = (NIM_BOOL)0;
						...
						dir = current;
						pX60gensym1153137__2 = slash___QVqo5OOQAdrjFqBsPctklw(dir, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
						{
							NIM_BOOL T51_;
							T51_ = (NIM_BOOL)0;
							T51_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153137__2);
							if (!T51_) goto LA52_;
							runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153137__2, NIM_FALSE, conf);
						}
						LA52_: ;
					}
				} LA42: ;
			...
			LA31_: ;
			{
					...
					res = ((NI) 0);
					{
						while (1) {
							...
							i = res;
							{
								NIM_BOOL T60_;
								NIM_BOOL T62_;
								NimStringDesc* pX60gensym1153137__3;
								T60_ = (NIM_BOOL)0;
								...
								pX60gensym1153137__3 = slash___QVqo5OOQAdrjFqBsPctklw(dir, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
								{
									NIM_BOOL T68_;
									T68_ = (NIM_BOOL)0;
									T68_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153137__3);
									if (!T68_) goto LA69_;
									runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153137__3, NIM_FALSE, conf);
								}
								LA69_: ;
							}
							LA64_: ;
				...
				{
					NimStringDesc* pX60gensym1153137__4;
					if (!NIM_FALSE) goto LA73_;
					dir = colontmp_;
					pX60gensym1153137__4 = slash___QVqo5OOQAdrjFqBsPctklw(dir, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
					{
						NIM_BOOL T77_;
						T77_ = (NIM_BOOL)0;
						T77_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153137__4);
						if (!T77_) goto LA78_;
						runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153137__4, NIM_FALSE, conf);
					}
					LA78_: ;
				}
				LA73_: ;
	...
	LA26_: ;
	{
		NimStringDesc* pX60gensym1153145_;
		if (!!((((*conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption__RAfAEZqjnKMDumgyKKc1qw) 16))&63U)))!=0))) goto LA82_;
		pX60gensym1153145_ = slash___QVqo5OOQAdrjFqBsPctklw((*conf).projectPath, ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_11));
		{
			NIM_BOOL T86_;
			T86_ = (NIM_BOOL)0;
			T86_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153145_);
			if (!T86_) goto LA87_;
			runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153145_, NIM_FALSE, conf);
		}
		LA87_: ;
	}
	LA82_: ;
	{
		...
		{
			NimStringDesc* pX60gensym1153148_;
			if (!!((*self).suggestMode)) goto LA92_;
			pX60gensym1153148_ = scriptFile;
			{
				NIM_BOOL T96_;
				T96_ = (NIM_BOOL)0;
				T96_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153148_);
				if (!T96_) goto LA97_;
				runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153148_, NIM_FALSE, conf);
			}
			LA97_: ;
			{
				NIM_BOOL T101_;
		...
		LA92_: ;
		{
			{
				NIM_BOOL T117_;
				NimStringDesc* pX60gensym1153178_;
				T117_ = (NIM_BOOL)0;
				T117_ = eqeq___UCoYdHlZt2oxX9ceSn0adYg(scriptFile, (*conf).projectFull);
				if (!!(T117_)) goto LA118_;
				pX60gensym1153178_ = scriptFile;
				{
					NIM_BOOL T122_;
					T122_ = (NIM_BOOL)0;
					T122_ = fileExists__2KLbGVKGy3qOdtJ4Bb1ADgos(pX60gensym1153178_);
					if (!T122_) goto LA123_;
					runNimScript__9aK66nKYiNl2TBdU36GDs9aA(cache, pX60gensym1153178_, NIM_FALSE, conf);
				}
				LA123_: ;
			}
			goto LA115_;
