		...
		suffix = substr__iGg0RIKceRvsmvq8FUHOEw(s, (NI)(ri + ((NI) 1)));
		{
			...
			splitsX60gensym281813_ = ((NI) -1);
			{
				while (1) {
					...
					NimStringDesc* T18_;
					if (!(lastX60gensym281812_ <= (colontmp_ ? colontmp_->Sup.len : 0))) goto LA9;
					firstX60gensym281814_ = lastX60gensym281812_;
					{
						while (1) {
							NIM_BOOL T12_;
							T12_ = (NIM_BOOL)0;
							T12_ = (lastX60gensym281812_ < (colontmp_ ? colontmp_->Sup.len : 0));
							if (!(T12_)) goto LA13_;
							T12_ = !(((NU8)(colontmp_->data[lastX60gensym281812_]) == (NU8)(124)));
							LA13_: ;
							if (!T12_) goto LA11;
					...
					}
					{
						...
						lastX60gensym281812_ = (colontmp_ ? colontmp_->Sup.len : 0);
					}
					LA16_: ;
					middle = substr__2yh9cer0ymNRHlOOg8P7IuA(colontmp_, firstX60gensym281814_, (NI)(lastX60gensym281812_ - ((NI) 1)));
...
appendString(T18_, suffix);
					...
					{
						if (!(splitsX60gensym281813_ == ((NI) 0))) goto LA21_;
						goto LA8;
					}
					LA21_: ;
					splitsX60gensym281813_ -= ((NI) 1);
