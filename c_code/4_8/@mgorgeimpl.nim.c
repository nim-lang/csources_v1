...
N_LIB_PRIVATE N_NIMCALL(void, readOutput__IiLavfm8A7IFymWPlx7XCA)(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p, tyTuple__XOVT24GHXwqiEj5GCsEGCA* Result);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readLine__Z3k8HYNsCnt82WLNxaYQiQ)(tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* s);
...
TNimType NTI__XOVT24GHXwqiEj5GCsEGCA_;
...
STRING_LITERAL(TM__69a9b06YSkBJW7wqzuZfJ29aQ_3, "\011", 1);
STRING_LITERAL(TM__69a9b06YSkBJW7wqzuZfJ29aQ_4, "gorge_", 6);
STRING_LITERAL(TM__69a9b06YSkBJW7wqzuZfJ29aQ_5, "txt", 3);
STRING_LITERAL(TM__69a9b06YSkBJW7wqzuZfJ29aQ_7, "\012", 1);
...
N_LIB_PRIVATE N_NIMCALL(void, readOutput__IiLavfm8A7IFymWPlx7XCA)(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p, tyTuple__XOVT24GHXwqiEj5GCsEGCA* Result) {	tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* output;
	genericReset((void*)Result, (&NTI__XOVT24GHXwqiEj5GCsEGCA_));
	...
	output = nospoutputStream(p);
	{
		while (1) {
			...
			NimStringDesc* T4_;
			T3_ = (NIM_BOOL)0;
			T3_ = atEnd__i3a7v4VsGcqjjJxfg0YUUg_2(output);
			if (!!(T3_)) goto LA2;
			T4_ = (NimStringDesc*)0;
			T4_ = readLine__Z3k8HYNsCnt82WLNxaYQiQ(output);
...
appendString((*Result).Field0, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_7));
		} LA2: ;
	}
	{
...
N_LIB_PRIVATE N_NIMCALL(void, opGorge__PHM9cEmzUJYj3PsIVbIPnxQ)(NimStringDesc* cmd, NimStringDesc* input, NimStringDesc* cache, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyTuple__XOVT24GHXwqiEj5GCsEGCA* Result) {	NimStringDesc* workingDir;
	NimStringDesc* T1_;
{	genericReset((void*)Result, (&NTI__XOVT24GHXwqiEj5GCsEGCA_));
	T1_ = (NimStringDesc*)0;
	T1_ = toFullPath__VW1RaR1l9c9bPnJxr1KuvIrg(conf, info.fileIndex);
	workingDir = nosparentDir(T1_);
	{
		...
		TSafePoint TM__69a9b06YSkBJW7wqzuZfJ29aQ_6;
...
appendString(T6_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_3));
appendString(T6_, input);
appendString(T6_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_3));
appendString(T6_, cache);
		secureHash__qi7bJ7Ntyvry4psMKnopTA(T6_->data, (T6_ ? T6_->Sup.len : 0), h);
		T7_ = (NimStringDesc*)0;
		T8_ = (NimStringDesc*)0;
		T8_ = dollar___2r9adABFqPoalSCAWfm1KJQ(h);
		T7_ = rawNewString((T8_ ? T8_->Sup.len : 0) + 6);
appendString(T7_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_4));
appendString(T7_, T8_);
		filename = toGeneratedFile__vfkVoeYdbq9cXWDTNf536TQ(conf, T7_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_5));
		f = (FILE*)0;
		{
			NIM_BOOL T11_;
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
			LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_ = readAll__mQf9blHFlTwuSvJjirhpY6g(f);
			colontmp__2 = ((NI) 0);
		...
		pushSafePoint(&TM__69a9b06YSkBJW7wqzuZfJ29aQ_6);
		TM__69a9b06YSkBJW7wqzuZfJ29aQ_6.status = _setjmp(TM__69a9b06YSkBJW7wqzuZfJ29aQ_6.context);
		if (TM__69a9b06YSkBJW7wqzuZfJ29aQ_6.status == 0) {
			tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p;
			tyArray__8ZvwQIddfpj2THRVPsFzIQ T16_;
			nimZeroMem((void*)T16_, sizeof(tyArray__8ZvwQIddfpj2THRVPsFzIQ));
			p = nospstartProcess(cmd, workingDir, T16_, 0, NIM_NIL, 12);
			{
				...
				write__egjcKjt8WddLFyjTFl5BAw(T21_, input);
				T22_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
				T22_ = nospinputStream(p);
				close__y1KA3B0U09bKtU09am9a9avRYQ_3(T22_);
			}
			LA19_: ;
			readOutput__IiLavfm8A7IFymWPlx7XCA(p, Result);
			nospclose(p);
			readSuccessful = NIM_TRUE;
			{
				if (!((*Result).Field1 == ((NI) 0))) goto LA25_;
				writeFile__D6Pj9c29aCLEJP9beOWa08HYA(filename, (*Result).Field0);
			}
			LA25_: ;
			popSafePoint();
		}
			...
			popSafePoint();
			if (isObj(getCurrentException()->Sup.m_type, (&NTI__iLZrPn9anoh9ad1MmO0RczFw_))||isObj(getCurrentException()->Sup.m_type, (&NTI__BeJgrOdDsczOwEWOZbRfKA_))) {
				TM__69a9b06YSkBJW7wqzuZfJ29aQ_6.status = 0;
				{
		...
		if (TM__69a9b06YSkBJW7wqzuZfJ29aQ_6.status != 0) reraiseException();
	}
	goto LA2_;
	LA4_: ;
	{
		TSafePoint TM__69a9b06YSkBJW7wqzuZfJ29aQ_8;
		pushSafePoint(&TM__69a9b06YSkBJW7wqzuZfJ29aQ_8);
		TM__69a9b06YSkBJW7wqzuZfJ29aQ_8.status = _setjmp(TM__69a9b06YSkBJW7wqzuZfJ29aQ_8.context);
		if (TM__69a9b06YSkBJW7wqzuZfJ29aQ_8.status == 0) {
			tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p_2;
			tyArray__8ZvwQIddfpj2THRVPsFzIQ T35_;
			nimZeroMem((void*)T35_, sizeof(tyArray__8ZvwQIddfpj2THRVPsFzIQ));
			p_2 = nospstartProcess(cmd, workingDir, T35_, 0, NIM_NIL, 12);
			{
				tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* T40_;
				tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* T41_;
				if (!!(((input ? input->Sup.len : 0) == ((NI) 0)))) goto LA38_;
				T40_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
				T40_ = nospinputStream(p_2);
				write__egjcKjt8WddLFyjTFl5BAw(T40_, input);
				T41_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
				T41_ = nospinputStream(p_2);
				close__y1KA3B0U09bKtU09am9a9avRYQ_3(T41_);
			}
			LA38_: ;
			readOutput__IiLavfm8A7IFymWPlx7XCA(p_2, Result);
			nospclose(p_2);
			popSafePoint();
		}
		else {
			...
			if (isObj(getCurrentException()->Sup.m_type, (&NTI__iLZrPn9anoh9ad1MmO0RczFw_))||isObj(getCurrentException()->Sup.m_type, (&NTI__BeJgrOdDsczOwEWOZbRfKA_))) {
				...
				NI colontmp__6;
				TM__69a9b06YSkBJW7wqzuZfJ29aQ_8.status = 0;
		...
		if (TM__69a9b06YSkBJW7wqzuZfJ29aQ_8.status != 0) reraiseException();
	}
	LA2_: ;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, compiler_gorgeimplDatInit000)(void) {
static TNimNode* TM__69a9b06YSkBJW7wqzuZfJ29aQ_2_2[2];
static TNimNode TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[3];
NTI__XOVT24GHXwqiEj5GCsEGCA_.size = sizeof(tyTuple__XOVT24GHXwqiEj5GCsEGCA);
NTI__XOVT24GHXwqiEj5GCsEGCA_.kind = 18;
NTI__XOVT24GHXwqiEj5GCsEGCA_.base = 0;
NTI__XOVT24GHXwqiEj5GCsEGCA_.flags = 2;
TM__69a9b06YSkBJW7wqzuZfJ29aQ_2_2[0] = &TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[1];
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[1].kind = 1;
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[1].offset = offsetof(tyTuple__XOVT24GHXwqiEj5GCsEGCA, Field0);
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[1].typ = (&NTI__77mFvmsOLKik79ci2hXkHEg_);
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[1].name = "Field0";
TM__69a9b06YSkBJW7wqzuZfJ29aQ_2_2[1] = &TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[2];
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[2].kind = 1;
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[2].offset = offsetof(tyTuple__XOVT24GHXwqiEj5GCsEGCA, Field1);
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[2].typ = (&NTI__rR5Bzr1D5krxoo1NcNyeMA_);
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[2].name = "Field1";
TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[0].len = 2; TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[0].kind = 2; TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[0].sons = &TM__69a9b06YSkBJW7wqzuZfJ29aQ_2_2[0];
NTI__XOVT24GHXwqiEj5GCsEGCA_.node = &TM__69a9b06YSkBJW7wqzuZfJ29aQ_0[0];
}
