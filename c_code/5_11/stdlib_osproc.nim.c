...
typedef N_CLOSURE_PTR(void, TM__HZdw8BhppcTQo8DIK46LSg_22) (NI idx, tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p);
...
static NIM_CONST tyProc__kElEuvYkhDcTHhB3d89aMYA TM__HZdw8BhppcTQo8DIK46LSg_16 = {NIM_NIL,NIM_NIL};
static NIM_CONST tyProc__FM4RO2zoXex9caTkjWpBmsw TM__HZdw8BhppcTQo8DIK46LSg_18 = {NIM_NIL,NIM_NIL};
...
{	result = (pid_t)0;
	...
	if (TM__HZdw8BhppcTQo8DIK46LSg_11.status == 0) {
		...
		sizeRead = read((*data).pErrorPipe[(((NI) 0))- 0], ((void*) ((&error))), ((NI) 4));
		{
			...
			T25_ = nsuFormatOpenArray(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_13), T23_, 2);
	...
	if (TM__HZdw8BhppcTQo8DIK46LSg_8.status == 0) {
		...
		if (TM__HZdw8BhppcTQo8DIK46LSg_10.status == 0) {
			...
			pid = startProcessAuxFork__fxpm29cY48fSnfKctT4HQMg((&data));
			{
				...
				T42_[1] = copyString(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_14));
				T42_[2] = nsuJoinSep(args, argsLen_0, ((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_14));
				echoBinSafe(T42_, 3);
			}
			LA40_: ;
			(*result).id = pid;
...
{	result = (NI)0;
				...
				while (1) {
					...
					count = kevent(kqFD, (&kevIn), ((int) 1), (&kevOut), ((int) 1), (&tmspec));
					{
						...
						err = osLastError__9bUWNxbcGnToMWA9b79aTXLIw();
						{
							...
							raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T38_, ((NimStringDesc*) NIM_NIL));
						}
						LA36_: ;
					}
					goto LA30_;
					...
					LA40_: ;
					{
						...
						LA59_: ;
						{
							NI32 T68_;
							T68_ = (NI32)0;
							T68_ = osLastError__9bUWNxbcGnToMWA9b79aTXLIw();
							raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T68_, ((NimStringDesc*) NIM_NIL));
						}
						LA55_: ;
					}
					LA30_: ;
	...
	LA6_: ;
	T72_ = (int)0;
	T72_ = exitStatusLikeShell__vmXOHpv9cjOB5AHi6OOlhbw((*p).exitStatus);
	result = ((NI) (T72_));
	}BeforeRet_: ;
	return result;
}
	...
	result = (NI)0;
	{
		...
		m = ((n <= cmdsLen_0) ? n : cmdsLen_0);
		{
			while (1) {
				...
				if (!(i < m)) goto LA6;
				{
					if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClE_0))) goto LA9_;
			...
			while (1) {
				if (!(((NI) 0) < ecount)) goto LA13;
				{
					...
					LA15_: ;
					{
						...
						{
							if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_18.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_18.ClE_0))) goto LA60_;
							afterRunEvent.ClE_0? afterRunEvent.ClP_0(idxs->data[rexit], q->data[rexit], afterRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_19)(afterRunEvent.ClP_0))(idxs->data[rexit], q->data[rexit]);
						}
						LA60_: ;
						nospclose(q->data[rexit]);
						{
							...
							{
								if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClE_0))) goto LA68_;
								beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_20)(beforeRunEvent.ClP_0))(i);
							}
							LA68_: ;
	...
	{
		{
			...
			res_4 = ((NI) 0);
			{
				while (1) {
					...
					i_2 = res_4;
					{
						if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_16.ClE_0))) goto LA78_;
						beforeRunEvent.ClE_0? beforeRunEvent.ClP_0(i_2, beforeRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_21)(beforeRunEvent.ClP_0))(i_2);
					}
					LA78_: ;
					...
					{
						if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_18.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_18.ClE_0))) goto LA84_;
						afterRunEvent.ClE_0? afterRunEvent.ClP_0(i_2, p, afterRunEvent.ClE_0):((TM__HZdw8BhppcTQo8DIK46LSg_22)(afterRunEvent.ClP_0))(i_2, p);
					}
					LA84_: ;
					nospclose(p);
					res_4 += ((NI) 1);
