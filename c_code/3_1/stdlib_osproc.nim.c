...
static NIM_CONST tyProc__kElEuvYkhDcTHhB3d89aMYA TM__HZdw8BhppcTQo8DIK46LSg_13 = {NIM_NIL,NIM_NIL};
static NIM_CONST tyProc__FM4RO2zoXex9caTkjWpBmsw TM__HZdw8BhppcTQo8DIK46LSg_15 = {NIM_NIL,NIM_NIL};
			...
			while (1) {
				if (!(((NI) 0) < ecount)) goto LA13;
				{
					...
					LA15_: ;
					{
						...
						{
							if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_15.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_15.ClE_0))) goto LA60_;
						...
						nospclose(q->data[rexit]);
						{
							...
							{
								if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_13.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_13.ClE_0))) goto LA68_;
	...
	{
		{
			...
			res_4 = ((NI) 0);
			{
				while (1) {
					...
					i_2 = res_4;
					{
						if (!!((beforeRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_13.ClP_0 && beforeRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_13.ClE_0))) goto LA78_;
					...
					{
						if (!!((afterRunEvent.ClP_0 == TM__HZdw8BhppcTQo8DIK46LSg_15.ClP_0 && afterRunEvent.ClE_0 == TM__HZdw8BhppcTQo8DIK46LSg_15.ClE_0))) goto LA84_;
