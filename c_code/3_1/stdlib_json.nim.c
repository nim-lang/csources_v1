...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q*, parseJson__WzaWBorCQCRzsZmH9bGowsQ)(tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* s, NimStringDesc* filename) {	tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q* volatile result;
	...
	TM__9b9bytt1stv9cZ8uqII7HFgew_14.status = _setjmp(TM__9b9bytt1stv9cZ8uqII7HFgew_14.context);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q*, parseFile__Q9bbQtVlwjGc4S8fnWe9b3YA)(NimStringDesc* filename) {	tyObject_JsonNodeObj__df9bshXB7C9cTiWPIOtX3j1Q* result;
	...
	{
		tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw* eX60gensym463002_;
		NimStringDesc* T5_;
		if (!(stream == NIM_NIL)) goto LA3_;
		eX60gensym463002_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*)0;
		eX60gensym463002_ = (tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw*) newObj((&NTI__HMIVdYjdZYWskTmTQVo5BQ_), sizeof(tyObject_IOError__iLZrPn9anoh9ad1MmO0RczFw));
		(*eX60gensym463002_).Sup.Sup.Sup.m_type = (&NTI__iLZrPn9anoh9ad1MmO0RczFw_);
		(*eX60gensym463002_).Sup.Sup.name = "IOError";
		T5_ = (NimStringDesc*)0;
...
appendString(T5_, filename);
		asgnRef((void**) (&(*eX60gensym463002_).Sup.Sup.message), T5_);
		asgnRef((void**) (&(*eX60gensym463002_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym463002_, "IOError", "parseFile", "json.nim", 877);
	}
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, indent__5gehovIFYjiBH1k6tFdATg)(NimStringDesc** s, NI i) {	NimStringDesc* T1_;
	T1_ = (NimStringDesc*)0;
	T1_ = spaces__zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) (i)));
