...
N_LIB_PRIVATE N_NIMCALL(NI, runeOffset__HH7qb6brPoi1FrBYRqXweg)(NimStringDesc* s, NI pos, NI start);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ, parseStandardFormatSpecifier__VVCKI4fK6GYPxQ9cDpjISyA)(NimStringDesc* s, NI start, NIM_BOOL ignoreUnknownSuffix) {	tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ result;
	...
	{
		NIM_BOOL T47_;
		tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* eX60gensym376460_;
		NimStringDesc* T51_;
		...
		LA48_: ;
		if (!T47_) goto LA49_;
		eX60gensym376460_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
		eX60gensym376460_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
		(*eX60gensym376460_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
		(*eX60gensym376460_).Sup.Sup.name = "ValueError";
...
appendString(T51_, T53_);
		asgnRef((void**) (&(*eX60gensym376460_).Sup.Sup.message), T51_);
		asgnRef((void**) (&(*eX60gensym376460_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym376460_, "ValueError", "parseStandardFormatSpecifier", "strformat.nim", 417);
	}
	LA49_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, formatValue__3zjq9csYPBcIN7AqvyU5ZLA)(NimStringDesc** result, NimStringDesc* value, NimStringDesc* specifier) {	tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ spec;
	...
	default:
	{
		tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* eX60gensym376698_;
		NimStringDesc* T3_;
		eX60gensym376698_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
		eX60gensym376698_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
		(*eX60gensym376698_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
		(*eX60gensym376698_).Sup.Sup.name = "ValueError";
		T3_ = (NimStringDesc*)0;
		T3_ = rawNewString(65);
appendString(T3_, ((NimStringDesc*) &TM__qDXzsifTQdn8ucTam9cFp4w_3));
appendChar(T3_, spec.typ);
		asgnRef((void**) (&(*eX60gensym376698_).Sup.Sup.message), T3_);
		asgnRef((void**) (&(*eX60gensym376698_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym376698_, "ValueError", "formatValue", "strformat.nim", 507);
	}
	break;
	}
	{
		if (!!((spec.precision == ((NI) -1)))) goto LA6_;
		{
			...
			T13_ = (NI)0;
			T13_ = runeOffset__HH7qb6brPoi1FrBYRqXweg(value_2, ((NI) (spec.precision)), ((NI) 0));
...
appendString((*result), T5_);
	...
	default:
	{
		tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* eX60gensym384220_;
		NimStringDesc* T11_;
		eX60gensym384220_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
		eX60gensym384220_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
		(*eX60gensym384220_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
		(*eX60gensym384220_).Sup.Sup.name = "ValueError";
...
appendChar(T11_, spec.typ);
		asgnRef((void**) (&(*eX60gensym384220_).Sup.Sup.message), T11_);
		asgnRef((void**) (&(*eX60gensym384220_).Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym384220_, "ValueError", "formatValue", "strformat.nim", 436);
	}
	break;
	}
