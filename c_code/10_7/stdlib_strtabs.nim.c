...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc**, nstTake)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {	NimStringDesc** result;
	NI indexX60gensym356298_;
	result = (NimStringDesc**)0;
	indexX60gensym356298_ = rawGet__X5BdUJaOXir9aSEySVC9auGg(t, key);
	{
		if (!(((NI) 0) <= indexX60gensym356298_)) goto LA3_;
		result = (&(*t).data->data[indexX60gensym356298_].Field1);
	}
	goto LA1_;
	LA3_: ;
	{
		tyObject_KeyError__t7nhKLvXTQS9cS8ByJU9bIag* eX60gensym356403_;
		NimStringDesc* T6_;
		eX60gensym356403_ = (tyObject_KeyError__t7nhKLvXTQS9cS8ByJU9bIag*)0;
		eX60gensym356403_ = (tyObject_KeyError__t7nhKLvXTQS9cS8ByJU9bIag*) newObj((&NTI__8SzoIAgLw9ci2v0yafHj9b6Q_), sizeof(tyObject_KeyError__t7nhKLvXTQS9cS8ByJU9bIag));
		(*eX60gensym356403_).Sup.Sup.Sup.Sup.m_type = (&NTI__t7nhKLvXTQS9cS8ByJU9bIag_);
		(*eX60gensym356403_).Sup.Sup.Sup.name = "KeyError";
		T6_ = (NimStringDesc*)0;
		T6_ = rawNewString((key ? key->Sup.len : 0) + 15);
appendString(T6_, ((NimStringDesc*) &TM__ZT9crccxweoChVXn9cHcxIXQ_7));
appendString(T6_, key);
		asgnRef((void**) (&(*eX60gensym356403_).Sup.Sup.Sup.message), T6_);
		asgnRef((void**) (&(*eX60gensym356403_).Sup.Sup.Sup.parent), NIM_NIL);
		raiseExceptionEx((Exception*)eX60gensym356403_, "KeyError", "[]", "strtabs.nim", 142);
	}
	LA1_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, raiseFormatException__BpIt9aRCHAcEdOBijnqAuEw)(NimStringDesc* s) {	tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* eX60gensym357038_;
	NimStringDesc* T1_;
	eX60gensym357038_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
	eX60gensym357038_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
	(*eX60gensym357038_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
	(*eX60gensym357038_).Sup.Sup.name = "ValueError";
	T1_ = (NimStringDesc*)0;
	T1_ = rawNewString((s ? s->Sup.len : 0) + 30);
appendString(T1_, ((NimStringDesc*) &TM__ZT9crccxweoChVXn9cHcxIXQ_8));
appendString(T1_, s);
	asgnRef((void**) (&(*eX60gensym357038_).Sup.Sup.message), T1_);
	asgnRef((void**) (&(*eX60gensym357038_).Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym357038_, "ValueError", "raiseFormatException", "strtabs.nim", 295);
}
