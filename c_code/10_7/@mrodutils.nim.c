...
N_LIB_PRIVATE N_NIMCALL(void, encodeVIntAux__lNzvVCaz9agOxH6nqWMG4Ww_2)(NI x, NimStringDesc** result) {	NIM_CHAR dX60gensym559477_;
	NI vX60gensym559478_;
	NI remX60gensym559479_;
	NI idxX60gensym559480_;
	dX60gensym559477_ = (NIM_CHAR)0;
	vX60gensym559478_ = x;
	remX60gensym559479_ = (NI)(vX60gensym559478_ % ((NI) 190));
	{
		if (!(remX60gensym559479_ < ((NI) 0))) goto LA3_;
		unsureAsgnRef((void**) (&(*result)), addChar((*result), 45));
		vX60gensym559478_ = ((NI32)-((NI)(vX60gensym559478_ / ((NI) 190))));
		remX60gensym559479_ = ((NI32)-(remX60gensym559479_));
	}
	goto LA1_;
	LA3_: ;
	{
		vX60gensym559478_ = (NI)(vX60gensym559478_ / ((NI) 190));
	}
	LA1_: ;
	idxX60gensym559480_ = remX60gensym559479_;
	{
		if (!(idxX60gensym559480_ < ((NI) 62))) goto LA8_;
		dX60gensym559477_ = ((NimStringDesc*) &TM__mZLUkjbotQF2WK9bQcNKBCA_7)->data[idxX60gensym559480_];
	}
	goto LA6_;
	LA8_: ;
	{
		dX60gensym559477_ = ((NIM_CHAR) (((NI) ((NI)((NI)(idxX60gensym559480_ - ((NI) 62)) + ((NI) 128))))));
	}
	LA6_: ;
	{
		if (!!((vX60gensym559478_ == ((NI) 0)))) goto LA13_;
		encodeVIntAux__lNzvVCaz9agOxH6nqWMG4Ww_2(vX60gensym559478_, result);
	}
	LA13_: ;
	unsureAsgnRef((void**) (&(*result)), addChar((*result), dX60gensym559477_));
}
