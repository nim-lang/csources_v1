...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath__LofaeXg9cmO8pKsmWT9a9bH9bw)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {	NimStringDesc* path;
	...
	resultX60gensym475050_ = NIM_NIL;
	{
		...
		glob_t fX60gensym338870_;
		NI resX60gensym338871_;
		int T2_;
		...
		nimZeroMem((void*)(&fX60gensym338870_), sizeof(glob_t));
		resX60gensym338871_ = (NI)0;
		fX60gensym338870_.gl_offs = ((NI) 0);
		fX60gensym338870_.gl_pathc = ((NI) 0);
		fX60gensym338870_.gl_pathv = NIM_NIL;
		T2_ = (int)0;
		T2_ = glob(nimToCStringConv(colontmp_), ((int) 0), NIM_NIL, (&fX60gensym338870_));
		resX60gensym338871_ = ((NI) (T2_));
		...
		if (TM__asNQM9aynXXg9ccUABbReyew_10.status == 0) {
			{
				if (!(resX60gensym338871_ == ((NI) 0))) goto LA6_;
				{
					NI iX60gensym338876_;
					NI colontmp__2;
					NI res;
					iX60gensym338876_ = (NI)0;
					colontmp__2 = (NI)0;
					colontmp__2 = (NI)(fX60gensym338870_.gl_pathc - ((NI) 1));
					res = ((NI) 0);
					{
						while (1) {
							NimStringDesc* pathX60gensym338877_;
							if (!(res <= colontmp__2)) goto LA10;
							iX60gensym338876_ = res;
							pathX60gensym338877_ = cstrToNimstr(fX60gensym338870_.gl_pathv[iX60gensym338876_]);
							{
								NI T15_;
								NimStringDesc* T16_;
								if (!NIM_TRUE) goto LA13_;
								xX60gensym475051_ = pathX60gensym338877_;
								...
								T15_ = resultX60gensym475050_->Sup.len++;
								T16_ = (NimStringDesc*)0;
								T16_ = resultX60gensym475050_->data[T15_]; resultX60gensym475050_->data[T15_] = copyStringRC1(xX60gensym475051_);
