...
N_LIB_PRIVATE N_NOINLINE(void, raiseParseErr__VeBRAkMdST9cPQW1Rqk8vwA)(tyObject_JsonParser__KWIQnzXEOUqdWsnCUL9atyQ* p, NimStringDesc* msg) {	tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg* eX60gensym441962_;
	eX60gensym441962_ = (tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg*)0;
	eX60gensym441962_ = (tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg*) newObj((&NTI__PyuSdojUZWOAnzN7dInq1Q_), sizeof(tyObject_JsonParsingError__XTejXaID1NT7KS9byQm3Jxg));
	(*eX60gensym441962_).Sup.Sup.Sup.Sup.m_type = (&NTI__XTejXaID1NT7KS9byQm3Jxg_);
	(*eX60gensym441962_).Sup.Sup.Sup.name = "JsonParsingError";
	asgnRef((void**) (&(*eX60gensym441962_).Sup.Sup.Sup.message), errorMsgExpected__wyJNOK33UcOVCdJ9aSuAbOw(p, msg));
	asgnRef((void**) (&(*eX60gensym441962_).Sup.Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym441962_, "JsonParsingError", "raiseParseErr", "parsejson.nim", 522);
}
