...
N_LIB_PRIVATE N_NIMCALL(NI, readBuffer__Y9atVWUcVyKHG9aBP4D0P9czA_2)(FILE* f, void* buffer, NI len) {	NI result;
	result = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, readLines__SgtYKLMb9cNidg5iRn9aNDJA)(NimStringDesc* filename, NI n) {	tySequence__sM4lkSb7zS6F7OVMvW9cffQ* volatile result;
	FILE* f;
	...
	f = (FILE*)0;
	{
		...
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status == 0) {
			result = newSeq__q7W9bxIQ7BrFLngLO9cYelsA(n);
			{
				NI i;
				NI colontmp_;
				NI res;
